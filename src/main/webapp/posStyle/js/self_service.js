...
$(document).ready(function () {
    ...
    $('#dine_in_button,#take_away_button').on('click', function () {

        // check if user info is submitted or not
        if(!window.currentCustomer) {
            $('#add_customer_modal').fadeIn('200');
            return false;
        }
    ...
    $('#place_order_operation').on('click', function () {
        ...
        var customer_id = window.currentCustomer.customer_id;
        ...
        if (selected_order_type_object.length > 0) {
            var order_type = 1;
            if (selected_order_type_object.attr('id') == 'dine_in_button') {
                order_type = 1;
                if (waiter_id == "") {
                    swal({
                        title: warning + "!",
    ...
    $('#add_customer').on('click', function () {
        ...
        $.ajax({
            url: base_url + "customer/add_customer_by_ajax",
            method: "POST",
            data: {
            ...
            success: function (response) {
                ...
                if (data.is_success) {
                    ...
                    window.currentCustomer = new_customer;
