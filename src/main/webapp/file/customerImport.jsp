...
<title><bean:message key="BzComposer.importcustomertitle"/></title>
</head>
<body>
<html:form action="File.do?tabid=ImportCustomer" method="post" enctype="MULTIPART/FORM-DATA" styleId="uploadForm">
	<div>
		...
		<a href="${pageContext.request.contextPath}/samplefile/BCA customer data template.csv" download class="formbutton">
 			<bean:message key="BzComposer.customerimport.csvfiledownload"/>
		</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="${pageContext.request.contextPath}/samplefile/BCA customer data template.xls" download class="formbutton">
 			<bean:message key="BzComposer.customerimport.excelfiledownload"/>
		</a>
	...
	<div style="margin-top: 40px">
	 <table>
	 	<tr>
	 		<td>
	 			<bean:message key="BzComposer.customerimport.csvorexcelfile"/>
 			</td>
...
function upload()
{
	document.forms[0].action = "File.do?tabid=UploadCustomerFile";
