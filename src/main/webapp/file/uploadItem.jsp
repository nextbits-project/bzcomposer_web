...
<title><bean:message key="BzComposer.importitemtitle"/></title>
</head>
<body>
<html:form action="Item.do?tabid=UploadItemFile" method="post" enctype="MULTIPART/FORM-DATA" styleId="uploadForm">
	<div>
		...
		<a href="${pageContext.request.contextPath}/samplefile/BCA item data template.csv" download class="formbutton">
 			<bean:message key="BzComposer.itemimport.csvfiledownload"/>
		</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="${pageContext.request.contextPath}/samplefile/BCA item data template.xls" download class="formbutton">
 			<bean:message key="BzComposer.itemimport.excelfiledownload"/>
		</a>
	...
	<div style="margin-top: 40px">
	 <table>
	 	<tr>
	 		<td>
	 			<bean:message key="BzComposer.itemimport.csvorexcelfile"/>	
 			</td>
	 		<td><html:file property="uploadItem"></html:file></td>
	 	</tr>
	 	<tr>
	 		<td>
	 			<input type="button" class="formbutton" value="<bean:message key='BzComposer.global.upload'/>" onclick="upload()"/>
	 		</td>
	 	</tr>
	 </table>
	</div>
	<div>
		<logic:present name="ItemUploaded">
...
function upload()
{
	document.forms[0].action = "Item.do?tabid=UploadItemFile";
