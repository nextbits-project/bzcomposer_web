...
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%>
<title><bean:message key="BzComposer.paidbilllisttitle"/></title>
				...
				<div class="unpaid">
						...
						<div class="filterbar" onclick="selectedRadio()">
							<div class="form-check form-check-inline">
					  			...
					  			<label class="form-check-label" for="inlineRadio1">
					  				<bean:message key="BzComposer.paidbilllist.showbillpayments"/>
				  				</label>
							</div>					
							<div class="form-check form-check-inline">
					  			<input class="form-check-input" type="radio" name="inlineRadioOptions" 
					  			...
					  			<label class="form-check-label" for="inlineRadio2">
					  				<bean:message key="BzComposer.paidbilllist.showrecurrentpaymentsbtn"/>
				  				</label>
							</div>
							<div class="form-check form-check-inline">
					  			<input class="form-check-input" type="radio" name="inlineRadioOptions" 
					  			...
					  			<label class="form-check-label" for="inlineRadio3">
					  				<bean:message key="BzComposer.paidbilllist.showpurchasebillpaymentsbtn"/>
				  				</label>
							</div>
							<div class="form-check form-check-inline">
					  			<input class="form-check-input" type="radio" name="inlineRadioOptions" 
					  			...
					  			<label class="form-check-label" for="inlineRadio4">
					  				<bean:message key="BzComposer.paidbilllist.showpaidcreditpaymentsbtn"/>
				  				</label>
							</div>
					...
					<div class="tab-content" id="nav-tabContent">
						...
						aria-labelledby="nav-home-tab">
									...
									<tbody>
									  <%
										...
										<tr onclick="selectrow(<%=paidBillLists.get(i).getBillNum() + "," + index%>)">
											...
											<td class="text-right">
												<% out.println(paidBillLists.get(i).getAmount());%>
											</td>
											<td class="text-right">
							...
							<div class="footer2">
								<button class="btn btn-info btn2" onclick="billingInfo()">
									<bean:message key="BzComposer.paidbilllist.printablechecksbtn"/>
								</button>
							</div>
						</div>
