...
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%>
<title><bean:message key="BzComposer.popayabletitle"/></title>
...
<div id="ddcolortabsline">&nbsp;</div>
 <html:form action="AccountReceiveble" method="post" >  								
	<div class="content1 clearfix">
		<h3 class="title1"><bean:message key="BzComposer.popayable.payabletitle"/></h3>
		<%
		...
		<div class="border1  clearfix">
			<form>
				<div class="row">
					<div class="col-md-4">
						<label><bean:message key="BzComposer.popayable.ponumber"/></label>
						
						 <label id="poNumber">
						    
						      </label>
						<div class="form-group row">
							<label class="col-md-4  col-form-label"><bean:message key="BzComposer.popayable.vendorname"/></label>
							<label id="custId" for="vendorName"> </label>
								
							</div>
						
						<div class="form-group row">
							<label class="col-md-4  col-form-label"><bean:message key="BzComposer.popayable.paymenttype"/></label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<label class="col-md-4  col-form-label"><bean:message key="BzComposer.popayable.payfrom"/></label>
							<div class="col-md-8">
						 ...
						 <div class="form-group row">
						<label class="col-md-4  col-form-label"><bean:message key="BzComposer.popayable.amount"/></label>
				    
				    	<div class="col-md-8">	
				    	<div class="input-group">
							<div class="input-group-prepend">
							 <span class="input-group-text" id="basic-addon1"><bean:message key="BzComposer.popayable.dollersign"/></span>
							 </div>
						 ...
						 <div class="form-group row">
							<label class="col-md-4  col-form-label"><bean:message key="BzComposer.popayable.paymentamount"/></label>
				...
				<div class="form-group row" id="Check">
							<label class="col-md-4  col-form-label">
								<bean:message key="BzComposer.popayable.checknumber"/>
							</label>
							<div class="col-md-8">
					...
					<div class="col-md-4">
						...
						<div class="form-group row">
							<label class="col-md-4  col-form-label"><bean:message key="BzComposer.popayable.date"/></label>
						...
						<div class="form-group row">
							<label class="col-md-4  col-form-label">
								<bean:message key="BzComposer.popayable.paiddate"/>
							</label>
						   <%--  <html:text property="orderDate" readonly="false"></html:text>  --%>
						...
						<div class="form-group row">
							<label class="col-md-4  col-form-label">
								<bean:message key="BzComposer.popayable.category"/>
							</label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<label class="col-md-4  col-form-label"><bean:message key="BzComposer.popayable.paymentstatus"/></label>
							<div class="col-md-8">
								<select class="form-control paymentOP" size="1" id="payStatus">
									<option value="Unpaid"><bean:message key="BzComposer.popayable.unpaid"/></option>
									<option value="Paid"><bean:message key="BzComposer.popayable.paid"/></option>
									<option value="Consignment"><bean:message key="BzComposer.popayable.consignment"/></option>
								</select>
							</div>
						</div>
					...
					<%-- <% if(receivablelistbean == null) {%>
						...
						<% } %>  --%>
						 <div class="form-group">
								<a class="btn btn-info btn2" onclick="return save()">
									<bean:message key="BzComposer.global.save"/>
								</a>
							</div>  
						<div class="form-group">
							<button class="btn btn-info btn1" onclick="return clearTransaction()">
								<bean:message key="BzComposer.popayable.cleartransactionbtn"/>
							</button>
						</div> 
					</div>
				</div>
			...
			<nav>
			   <div class="nav nav-tabs" id="tabId" role="tablist">
			    ...
			    aria-controls="nav-home" aria-selected="true">
			    	<bean:message key="BzComposer.popayable.tab.popayablelist"/>
		    	</a>
			    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" 
			    aria-controls="nav-profile" aria-selected="false" onclick="consignmentTab()">
			    	<bean:message key="BzComposer.popayable.tab.consignmentsalepayment"/>
		    	</a>
			    <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" 
			    aria-controls="nav-contact" aria-selected="false" onclick="paidList()">
			    	<bean:message key="BzComposer.popayable.tab.paidlist"/>
		    	</a>
			  </div>
			</nav>
				...
				<table class="table table-bordered table-sm devAcRecDataTbl">
				  <thead class="thead-light">
				    <tr>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.pay"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.ponum"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.companyname"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.vendorname"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.date"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.payfrom"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.paymenttype"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.amount"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.paid"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.balance"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.credit"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.category"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.memo"/></th>
				    </tr>
				  </thead>
				  <tbody>
				   <%
	...
	<div class="footer1">
		<a class="btn btn-info btn1" style="float: right;" id="pay"><bean:message key="BzComposer.popayable.paybtn"/></a>
  ...
  <table class="table table-bordered table-sm dlgRecDataTable" id="myTable">
   <tr><bean:message key="BzComposer.popayable.payablelist"/></tr>&nbsp;
    <thead>
      <tr>
        <th><bean:message key="BzComposer.popayable.vendor"/></th>
        <th><bean:message key="BzComposer.popayable.ponum"/></th>
        <th><bean:message key="BzComposer.popayable.category"/></th>
        <th><bean:message key="BzComposer.popayable.payfrom"/></th>
        <th><bean:message key="BzComposer.popayable.amountdue"/></th>
        <th><bean:message key="BzComposer.popayable.paid"/></th>
        <th><bean:message key="BzComposer.popayable.paymenttype"/></th>
        <th><bean:message key="BzComposer.popayable.checknumber"/></th>
      </tr>
    </thead>
    <tbody id="demo"></tbody>
  </table>
  ...
  <form>	
	  <div class="form-group row mb-0">
	    <label for="staticEmail" class="col-sm-5 col-form-label">
	    	<bean:message key="BzComposer.popayable.totalpayable"/>
    	</label>
	    <div class="col-sm-7">
	  ...
	  <div class="form-group row mb-0">
	    <label for="staticEmail" class="col-sm-5 col-form-label">
	    	<bean:message key="BzComposer.popayable.totalamounttopay"/>
    	</label>
	    <div class="col-sm-7">
   ...
   <div class=" col-4">
  	...
  	onclick="payFromDialog()">
  		<bean:message key="BzComposer.popayable.paybtn"/>
	</button>
  </div> 
  </div> 
  </div>
...
<script type="text/javascript">
	  ...
	  if(payment == 'Consignment')
		  {
		  	if($('input[id="Checkbox['+indexNumber+']"]').is(':checked'))
		  	{	
		  		/* var option = window.confirm("<bean:message key='BzComposer.popayable.wantlayawaysinvoice'/>");
		  		if(option != true)
			  	{
			  		return;
			  	} */
				...
				$("#savelayawaysinvoicedialog").dialog({
		  		...
		  		$.ajax({
				type : "POST",
				url : "PoPayable.do?tabid=Consignment",
   ...
   function sendMyValue(ReceivableListBean) {
   	 ...
   	 $.ajax({
			...
			type : "POST",
			url : "PoPayable.do?tabid=UpdateRecord",
   ...
   function clearTransaction()
   {
	  ...
	  /*  alert(indexNumber);
	   ...
	   {
		  /* answer = window.confirm("<bean:message key='BzComposer.popayable.clearselectedtransaction'/>");
		  if(answer != true)
		  {
		  		return false;
		  } */
  ...
  function paidList()
  {
	  window.location = "${pageContext.request.contextPath}/PaidListTab.do?tabid=paidList";
  }
  function consignmentTab()
  {
	  window.location = "${pageContext.request.contextPath}/PoPayable.do?tabid=consignmentTab";
  }
   /*  $(document.forms[0]).submit(function( event ) {
	    alert('Before submit');
	    event.preventDefault();
	});  */
	/*  document.forms[0].action="AccountReceiveble.do?tabid=saveInvoice&object="+save;
...
<div id="selectonepayabledialog" style="display:none;">
	<p><bean:message key='BzComposer.popayable.selectonepayable'/></p>
</div>
<div id="savelayawaysinvoicedialog" style="display:none;">
	<p><bean:message key='BzComposer.popayable.wantlayawaysinvoice'/></p>
</div>
<div id="showerrordialog" style="display:none;">
	<p><bean:message key='BzComposer.popayable.someerroroccurred'/></p>
</div>
<div id="savereceiveamountdialog" style="display:none;">
	<p><bean:message key='BzComposer.popayable.receivedamountismorethanamount'/></p>
</div>
<div id="entervalidchecknumberdialog" style="display:none;">
	<p><bean:message key='BzComposer.popayable.entervalidchecknumber'/></p>
</div>
<div id="selecttransactiondialog" style="display:none;">
	<p><bean:message key='BzComposer.popayable.selecttransaction'/></p>
</div>
<div id="selectcleartransactiondialog" style="display:none;">
	<p><bean:message key='BzComposer.popayable.clearselectedtransaction'/></p>
</div>