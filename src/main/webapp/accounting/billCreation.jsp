...
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%>
<title><bean:message key="BzComposer.billcreationtitle"/></title>
	...
	<html:form action="AccountReceiveble" method="post" styleId="billPayableForm">
						...
						<div class="unpaid-right" id="totalAmountLabelDiv">
							<ul>
								<li>
									...
									<label> 
										<% out.println(allBill.get(allBill.size() - 1).getTotalBillAmount());%>
									</label>
								</li>
								<li>
									<button>
									...
									<div class="table1" id="payeeNamesForNavigation">
										<table class="table table-bordered table-sm decACPayeeTable">
											<thead class="thead-light">
												<tr>
													<th scope="col">
														<bean:message key="BzComposer.paidbilllist.payeename"/>
													</th>
												</tr>
											</thead>
											<tbody>
									...
									<div class="recurrentPaymentListForEdit" id="recurrentPaymentListForPayee">
			                    		<table class="tableRe reCurrent">
											<thead>
												<tr>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.payeeid"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.planid"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.paymentaccountid"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billpayable.amount"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.samepaymentamount"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.lastpamentamount"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.firstpaymentdate"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billpayable.frequency"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.days"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.recurrentoption"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.numberofoption"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billpayable.status"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.lastpaymentdate"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.plansetupdate"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.active"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.global.memo"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.customercurrentbalance"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.dateadded"/>
													</th>
													<th class="text-right">
														<bean:message key="BzComposer.billcreation.paymenttypeid"/>
													</th>
												</tr>
											</thead>
											<tbody>
										...
										<table class="table table-bordered table-sm devAcRecDataTbl">
											<thead class="thead-light">
												<tr>
													...
													<th scope="col" class="text-right">
														<bean:message key="BzComposer.billpayable.billno"/>
													</th>
													<th scope="col" class="text-right">
														<bean:message key="BzComposer.billpayable.payee"/>
													</th>
													<th scope="col" class="text-right">
														<bean:message key="BzComposer.billpayable.duedate"/>
													</th>
													<th scope="col" class="text-right">
														<bean:message key="BzComposer.billpayable.paidamount"/>
													</th>
													<th scope="col" class="text-right">
														<bean:message key="BzComposer.billpayable.amttopay"/>
													</th>
													<th scope="col" class="text-right">
														<bean:message key="BzComposer.billpayable.amount"/>
													</th>
											...
											<tbody>
												...
												<tr onclick="selectrow(<%=allBillLists.get(i).getBillNo() + "," + index%>)">
													...
													<td class="text-right">
														<% out.println(allBillLists.get(i).getAmountPaid());%>
													</td>
													<td class="text-right">
														<% out.println(allBillLists.get(i).getAmountTopay());%>
													</td>
													<td class="text-right">
														<% out.println(allBillLists.get(i).getAmount());%>
													</td>
													<td class="text-right">
		...
		<div class="container-fluid" id="PayBills">
			...
			<div class="table-responsive PayBills-popup" style="padding: 0 15px">
				...
				<div class="bzbtn text-right">
					<button type="button" class="btn btn-success" onclick="return deleteBankAccount()" 
					id="deleteBank">
						<bean:message key="BzComposer.billpayable.payselectedbillsbtn"/>
					</button>
					<button type="button" class="btn btn-success" onclick="return editTransaction()" 
					id="addButtonForDeposit">
						<bean:message key="BzComposer.global.cancel"/>
					</button>
				</div>
		...
		<div class="container-fluid" id="CreatingEditingRecurrentPaymentDlgId">
			...
			<div class="table-responsive" style="padding: 0 15px">
				<p>
					<b>
						<bean:message key="BzComposer.billcreation.payeeinformation"/>
					</b>
					<br> 
					<bean:message key="BzComposer.paidbilllist.payeename"/> *: 
							...
							<div class="col-sm-4 form-inline">
								<div class="form-group">
									<label for="allAMount">
										...
										&nbsp;
										<bean:message key="BzComposer.billcreation.allpaymentaresame"/>
									</label>
								</div>
							</div>
							<div class="col-sm-3 form-inline">
								<div class="form-group">
									...
									<span>
										<bean:message key="BzComposer.billcreation.optional"/>
									</span>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-4 form-inline">
								<div class="form-group">
									...
									type="radio">
										&nbsp;
										<bean:message key="BzComposer.billcreation.amountoflastpayment"/>
									</label>
								</div>
							</div>
							<div class="col-sm-3 form-inline">
				...
				<div class="row">
					<div class="col-md-12">
						<b>
							<bean:message key="BzComposer.billcreation.frequencyandduration"/>
						</b>
						<div class="row">
							<div class="col-sm-5 form-inline">
								<div class="form-group dateWrap">
									<label>
										<bean:message key="BzComposer.billcreation.deliverfirstpaymenton"/> 
										:
										&nbsp;
									</label> 
									<span> 
										<span class="placeholder">
											<bean:message key="BzComposer.billcreation.dateformat"/>
										</span> 
										<span class="d-flex">
						...
						<div class="row" style="margin-top: 15px;">
							<div class="col-sm-3 form-inline">
								<div class="form-group">
									<label>
										<bean:message key="BzComposer.billcreation.sendpayments"/> 
										*:
										&nbsp;
									</label> 
							...
							<span class="form-inline"> 
								<span class="form-group">
									<label for="setdatin">
										...
										&nbsp; 
										<bean:message key="BzComposer.billcreation.setindays"/>
									</label>
								</span> 
								<span class="form-group">
									&nbsp;&nbsp; 
								...
								<span class="form-group">
									...
									<label for="setdatinnextday">
										<bean:message key="BzComposer.billcreation.nextpaymentdate"/> 
										: &nbsp;
									</label>
							...
							<div class="col-sm-12 form-inline">
								<div class="form-group">
									...
									<input id="UntillIChange" name="untillchange" type="radio">
										&nbsp;
										<bean:message key="BzComposer.billcreation.untilchangeorcancelpayment"/>
									</label>
								</div>
							</div>
						</div>
							...
							<div class="col-sm-4 form-inline">
								<div class="form-group">
									<label for="chancle2">
										...
										&nbsp;
										<bean:message key="BzComposer.billcreation.untiltotalnumberof"/>
										&nbsp;
										<input type="text" class="form-control" id="numberOfPayments">
										&nbsp;
										<bean:message key="BzComposer.billcreation.paymentsent"/>
									</label>
								</div>
							</div>
						</div>
							...
							<div class="col-sm-4 form-inline">
								<div class="form-group">
									<label for="chancle3">
										...
										&nbsp;
										<bean:message key="BzComposer.billcreation.untilbutnotafter"/> 
										&nbsp;
										<span class="d-flex"> 
				...
				<hr>
				<div class="bzbtn text-right">
					<button type="button" class="btn btn-success" onclick="return setUpPayment()" id="setUpPayment">
						<bean:message key="BzComposer.billcreation.setuppaymentbtn"/>
					</button>
					<button type="button" class="btn btn-success" id="dontSetUpPayment">
						<bean:message key="BzComposer.billcreation.dontsetuppaymentbtn"/>
					</button>
				</div>
			</div>
		</div>
		<div class="container-fluid" id="EditingRecurrentPaymentDlgId">
			...
			<div class="table-responsive" style="padding: 0 15px">
				...
				<div class="box">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group row">
								<label class="col-md-4 col-form-label">
									<bean:message key="BzComposer.billcreation.payfromaccount"/>
									:
								</label>
								<div class="col-md-8">
						...
						<div class="col-sm-6">
							...
							<div class="form-group row">
								<label class="col-md-4 col-form-label">
									<bean:message key="BzComposer.billcreation.lastpaymentamt"/>
									*:
								</label>
								<div class="col-md-8">
							...
							<div class="form-group row">
								<label class="col-md-4 col-form-label">
									<bean:message key="BzComposer.billcreation.finalpaymentdate"/> 
									&nbsp;:
								</label>
								<div class="col-md-8">
									<div class="d-flex">
								...
								<div class="form-inline ">
									<div class="form-group">
										<label for="exampleInputName2">
											<bean:message key="BzComposer.billcreation.totalschedulepayments"/> 
											&nbsp;:
										</label> 
										<input type="text" class="form-control" 
								...
								<div class="form-inline justify-content-end">
									<div class="form-group ">
										<label for="exampleInputEmail2">
											<bean:message key="BzComposer.billcreation.totalscheduleamount"/> 
											&nbsp;:
										</label> 
				...
				<div class="bzbtn text-right">
					<button type="button" class="btn btn-success" onclick="return UpdateRecurrentPayment()" id="">
	...
	<div class="container-fluid" id="CreateBillDlgId">
		...
		<div class="table-responsive CreateBill" style="padding: 0 15px">
			<h5 class="text-center pt-1 pb-1">
				<bean:message key="BzComposer.billcreation.bill"/>
			</h5>
			<div class="form-check form-check-inline">
			...
			<div class="form-check form-check-inline">
				...
				<label class="form-check-label" for="rdoInvoiceOrder1">
					<bean:message key="BzComposer.billcreation.credit"/>
				</label>
			</div>
			<div class="row form-horizontal">
				<div class="col-md-6">
					<div class="form-group row">
						...
						<div class="col-md-8">
							<select class="form-control" id="selectBankForCreateBill">
								<option value="56933"><bean:message key="BzComposer.billpayable.chasebank"/></option>
							</select>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-4 col-form-label">
							<bean:message key="BzComposer.billpayable.vendor"/>:
						</label>
						<div class="col-md-8">
					...
					<div class="form-group row">
						<label class="col-md-4 col-form-label">
							<bean:message key="BzComposer.billcreation.address"/>&nbsp;
							:
						</label>
						<div class="col-md-8">
				...
				<div class="col-md-6">
					<div class="form-group row">
						<label class="col-md-4 col-form-label">
							<bean:message key="BzComposer.billcreation.billno"/>
						</label>
						<div class="col-md-8">
					...
					<div class="form-group row">
						<label class="col-md-4 col-form-label">
							<bean:message key="BzComposer.billcreation.billdue"/>
						</label>
						<div class="col-md-8">
							<div class="d-flex">
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<textarea class="form-control" rows="4" readonly="true" id="memoForCreateBill">
								<bean:message key="BzComposer.billcreation.vendorbill"/>
							</textarea>
						</div>
					</div>
				</div>
			...
			<div id="tabs" class="mb-3">
				<ul>
					<li>
						<a href="#tabs-1">
							<bean:message key="BzComposer.billcreation.expences"/>
						</a>
					</li>
					<li>
						<a href="#tabs-2">
							<bean:message key="BzComposer.billcreation.items"/>
						</a>
					</li>
				</ul>
					...
					<div class="table-responsive">
						<table class="table table-bordered">
							<thead>
								<tr>
									<th>
										<bean:message key="BzComposer.billcreation.account"/>
									</th>
									<th>
										<bean:message key="BzComposer.billpayable.amount"/>
									</th>
									...
									<th>
										<bean:message key="BzComposer.billcreation.customservice"/>
									</th>
									<th>
										<bean:message key="BzComposer.billcreation.billable"/>
									</th>
								</tr>
								</thead>
								<tbody>
					...
					<div id="tabs-2" class="pl-2 pr-2 pt-3 pb-1">
						<div class="table-responsive">
							<table class="table table-bordered">
								<thead>
									<tr>
										<th><bean:message key="BzComposer.billcreation.item"/></th>
										<th><bean:message key="BzComposer.billcreation.description"/></th>
										<th><bean:message key="BzComposer.billcreation.quantity"/></th>
										<th><bean:message key="BzComposer.billcreation.cost"/></th>
										<th><bean:message key="BzComposer.billcreation.amount"/></th>
										<th><bean:message key="BzComposer.billcreation.customer"/></th>
										<th><bean:message key="BzComposer.billcreation.billable"/></th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td>
											<select class="form-control">
												<option value="Inventory">
													<bean:message key="BzComposer.billcreation.inventory"/>
												</option>
												<option value="Chase Bank">
													<bean:message key="BzComposer.billpayable.chasebank"/>
												</option>
				...
				<div class="bzbtn text-right">
					<button type="button" class="btn btn-success">
						<bean:message key="BzComposer.billcreation.saveandnewbtn"/>
					</button>
					<button type="button" class="btn btn-success" onclick="return SaveCloseBill()">
						<bean:message key="BzComposer.billcreation.saveandclosebtn"/>
					</button>
...
<script type="text/javascript">
	...
	function save()
	{
		...
		$.ajax({
				...
				type : "POST",
				url : "BillCreation.do?tabid=save",			
			    data :"data=" + obj,
	...
	function makePayment()
	{
		...
		$.ajax({
			...
			type : "POST",
			url : "BillCreation.do?tabid=MakePayment",			
		    data :"data=" + obj,
		    success : function(data) {
			debugger;
			amountToBepaid = 0.00;
...
{			
	$.ajax({
			...
			type : "POST",
			url : "BillCreation.do?tabid=DeleteBill",			
		    data :"BillNum=" + billNo,
		    success : function(data) {
			debugger;
			updateBillPayableTab(data);	
	...
	function billCreationTab()
	{
		 ...
		 $(function() {
			   $( "#MemorizeBillId").on("click", function(){
				/*   $("#dateForAddAccount").val(dName+" "+((new Date().getMonth())+1)+"-"+new Date().getDate()+"-"+new Date().getFullYear()); */
				 ...
				 {
					 alert("<bean:message key='BzComposer.billcreation.selectunpaidbilllist'/>");
					 return false;
				 }
		...
		function ScheduleMemorizedTransactionOkay()
		{
			...
			$.ajax({
			 	...
			 	type : "POST",
				url : "BillCreation.do?tabid=MakeScheduleMemorizedTransaction",		 	
			    data :"data=" + obj,
			    success : function(data) {
				debugger;
				amountToBepaid = 0.00;
...
function DeleteMemorizeTransaction()
{
	...
	$.ajax({
	 	...
	 	type : "POST",
		url : "BillCreation.do?tabid=UpdateMemorizedTransaction",		 	
...
$.ajax({
	 	...
	 	type : "POST",
		url : "BillCreation.do?tabid=billCreation",		 	
...
function SaveCloseBill()
{
	...
	{
		alert("<bean:message key='BzComposer.billcreation.choosevalidcategory'/>");
		return false;
	}
	...
	{
		alert("<bean:message key='BzComposer.billcreation.choosevalidexpenseaccount'/>");
		return false;
	}
	...
	{
		alert("<bean:message key='BzComposer.billcreation.choosevalidexpensevendor'/>");
		return false;
	}
	...
	{
		alert("<bean:message key='BzComposer.billcreation.entervalidamount'/>");
		return false;
	}
	TblVendorDetail = {
			"billType": billType,
...
$.ajax({
	 	...
	 	type : "POST",
	 	url : "BillCreation.do?tabid=CreateBill", 		 	
...
function setUpPayment()
{
	...
	if(untillTotalNumber == true)
	{
		...
		if(numberOfPayments == '')
		{
			alert("<bean:message key='BzComposer.billcreation.entervalidnumberofpayments'/>");
			return false;
		}
	}
	if(untillTotalNumber == true)
...
$.ajax({
	 	...
	 	type : "POST",
	    url : "BillCreation.do?tabid=setUpPayment",  		 	
...
function UpdateRecurrentPayment()
{
	...
	if(planID == -1)
	{
		alert("<bean:message key='BzComposer.billcreation.selectpropervendor'/>");
		return false;
	}
...
$.ajax({
	 	...
	 	type : "POST",
	    url : "BillCreation.do?tabid=UpdateRecurrentPayment",  		 	
...
{
	window.location = "${pageContext.request.contextPath}/BillPayable.do?tabid=billpayable";
}
