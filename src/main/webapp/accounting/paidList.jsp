...
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%>
<title><bean:message key="BzComposer.paidlisttitle"/></title>
			...
			<form>
					...
					<div class="col-md-4">
						...
						<div class="form-group row">
							<label class="col-md-4  col-form-label">
								<bean:message key="BzComposer.popayable.vendor"/>
							</label>
						...
						<div class="form-group row">
							<label class="col-md-4  col-form-label">
								<bean:message key="BzComposer.popayable.paymenttype"/>
							</label>
							<div class="col-md-8">
						...
						<div class="form-group row">
							<label class="col-md-4  col-form-label">
								<bean:message key="BzComposer.popayable.payfrom"/>
							</label>
							<div class="col-md-8">
						 ...
						 <div class="form-group row">
						<label class="col-md-4  col-form-label">
							<bean:message key="BzComposer.popayable.amount"/>
						</label>
				    	...
				    	<div class="input-group">
							<div class="input-group-prepend">
							 <span class="input-group-text" id="basic-addon1">
							 	<bean:message key="BzComposer.popayable.dollersign"/>
							 </span>
							 </div>
						 ...
						 <div class="form-group row">
							<label class="col-md-4  col-form-label">
								<bean:message key="BzComposer.popayable.paymentamount"/>
							</label>
				...
				<div class="form-group row" id="Check">
					...
					<div class="col-md-4">
						...
						<div class="form-group row">
							<label class="col-md-4  col-form-label">
								<bean:message key="BzComposer.popayable.paymentstatus"/>
							</label>
							<div class="col-md-8">
		...
		<div class="content-tabs">
			...
			<div class="tab-content" id="nav-tabContent">
			  ...
			  <div class="filterbar">					
					...
					<label class="form-check-label" for="inlineRadio3">
						<bean:message key="BzComposer.popayable.consignmentpayment"/>
				  	</label>
					</div>
				...
				<table class="table table-bordered table-sm devAcRecDataTbl">
				  <thead class="thead-light">
				    <tr>
				      <th scope="col"><bean:message key="BzComposer.popayable.ponum"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.vendor"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.paiddate"/></th>
				      ...
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.paidamount"/></th>
...
/* 	 sendMyValue(row,paymentTypeId,checkNo,memo,accountId,categoryId,receivedAmount); */
   ...
   function sendMyValue(TblPayment,receivedAmount,paidDate) {
   	 ...
   	 $.ajax({
			...
			type : "POST",
			url : "PaidListTab.do?tabid=UpdateRecord",
   ...
   function clearTransaction()
   {
	   if(paymentId == '' || paymentId == -1)
		   ...
		   {
		   	var status = window.confirm("<bean:message key='BzComposer.popayable.clearselectedtransaction'/>");
		   	if(status != true)
		   		{
		   			return false;
		   		}
	   ...
	   $.ajax({
			...
			type : "POST",
			url : "PaidListTab.do?tabid=clearTransaction",			
	...
	$( ".rangeOP" ).change(function() 
	{
	   ...
	   var rangeType = document.getElementById("rangeId");
		...
		$.ajax
	  	({
			type : "GET",
	 		url : "PaidListTab.do?tabid=slectedMenu&SelectedRange=" + range, 
	    	success : function(data)
	    	{
	    		debugger;
