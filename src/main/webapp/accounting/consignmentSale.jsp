...
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%>
<title><bean:message key="BzComposer.consignmentsaletitle"/></title>
	...
	<div class="content1 clearfix">
			...
			<form>
				...
				<div class="form-group row" id="Check">
					...
					<div class="col-md-4">
						...
						<div class="form-group row">
							<label class="col-md-4  col-form-label">
								<bean:message key="BzComposer.popayable.date"/>
							</label>
					...
					<div class="col-md-4">
						 <div class="form-group">
								<button class="btn btn-info btn1" onclick="return save()">
		...
		<div class="content-tabs">
			   ...
			   <div class="nav nav-tabs" id="tabId" role="tablist">
				...
				<table class="table table-bordered table-sm devAcRecDataTbl">
				  <thead class="thead-light">
				    <tr>
				      <th scope="col"><bean:message key="BzComposer.popayable.pay"/></th>
				      ...
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.checknumber"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.date"/></th>
				      <th scope="col" class="text-right"><bean:message key="BzComposer.popayable.amounttopay"/></th>
			...
			<div class="footer1">
						...
						<button class="btn btn-info btn1" style="float: right;" id="pay"><bean:message key="BzComposer.popayable.paybtn"/></button>
   ...
   function clearTransaction()
   {
	  ...
	  /*  alert(indexNumber);
	   ...
	   $.ajax({
			...
			type : "POST",
			url : "PoPayable.do?tabid=clearFromConsignTab",
