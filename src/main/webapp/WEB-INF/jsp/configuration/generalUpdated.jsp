													...
													<div id="tabs" style="height: auto;">
														<ul>
															...
															<li style="font-size: 12px;"><a href="#Version"><spring:message
																		code="BzComposer.tab.version" /></a></li>
														</ul>
															...
															<div id="VersionContent" class="tabPage">
																<div>
																	<span class="inputHighlighted"><spring:message
																			code="BzComposer.configuration.productstitle" /></span>
																</div>
																<br>
																	...
																	<tr>
                                        								<td><label class="switch"> <input
																			...
																			${configDto.leadsIsActive=='1'?'checked':''}> 
																				...
																				code="BzComposer.configuration.version.leads" /> <br />
																	</td>
																	</tr>
																	...
																	<tr>
																		...
																		<input id="invoice" type="checkbox" value="${configDto.invoiceIsActive}"
																			${configDto.invoiceIsActive=='1'?'checked':''}> <span
																				...
																				code="BzComposer.configuration.version.invoice" />
																			<br /></td>
																		<td><label class="switch"> <input
																				id="estimation" type="checkbox" value="${configDto.estimationIsActive}"
																			${configDto.estimationIsActive=='1'?'checked':''}> <span
																				class="slider round"></span>
																		</label> <spring:message
																				code="BzComposer.configuration.version.estimation" />
																			<br /></td>
																	</tr>
																	...
																	<tr>
																		<td><label class="switch"> <input
																			...
																			<span
																				...
																				code="BzComposer.configuration.version.salesOrder" />
																			<br /></td>
																		<td><label class="switch"> <input
																				id="rma" type="checkbox" value="${configDto.rmaIsActive}"
																			${configDto.rmaIsActive=='1'?'checked':''}> <span
																				class="slider round"></span>
																		</label> <spring:message
																				code="BzComposer.configuration.version.rma" /> <br />
																	</td>
																	...
																	<tr>
																		<td><label class="switch"> <input
																			...
																			${configDto.dataManagarIsActive=='1'?'checked':''} > <span
																				...
																				code="BzComposer.configuration.version.dataManager" />
																			<br />
																			</td>
																	</tr>
																	...
																	<tr>
																		<td><label class="switch"> <input
																			...
																			${configDto.contactIsActive=='1'?'checked':''}> <span
																				...
																				code="BzComposer.configuration.version.contact" />
																			<br /></td>
																		<td><label class="switch"> <input
																				id="opportunities" type="checkbox" value="${configDto.opportunitiesIsActive}"
																			${configDto.opportunitiesIsActive=='1'?'checked':''}> <span
																				class="slider round"></span>
																		</label> <spring:message
														...
														<div id="GeneralSetting">
															<div id="content1" class="tabPage">
																<table class="table-notifications" width="80%">
																	<tr>
																		<th colspan="2" align="left"
																			style="font-size: 12px; padding: 5px;"><spring:message
																				code="BzComposer.configuration.generaltitle" /></th>
																	</tr>
																	<tr>
																		<td style="font-size: 12px;"><spring:message
																				code="BzComposer.configuration.currency" /></td>
																		<td style="font-size: 12px;"><form:select
																	...
																	<tr>
																		<td style="font-size: 12px;"><spring:message
																				code="BzComposer.configuration.weight" /></td>
																		<td style="font-size: 12px;"><form:select
																				path="weightID" style="font-size: 12px;"
																				id="weightID">
																				<c:if
																	...
																	<tr>
																		<th colspan="2" align="left"
																			style="font-size: 12px; padding: 5px;"><spring:message
																				code="BzComposer.configuration.addresslabel" /></th>
																	</tr>
																	<tr colspan="2">
																		<td style="font-size: 12px;"><spring:message
																		...
																		<td style="font-size: 12px;"><c:if
																				...
																				<form:select path="defaultLabelID"
																					onchange="SetLabelName(this.value);"
																					style="width:200" id="defaultLabelID">
																					<form:options items="${Labels}" itemValue="value"
																						itemLabel="label" />
																				</form:select>
																			</c:if></td>
																	</tr>
													...
													<form:option value="4"><spring:message code="BzComposer.configuration.defaultstartingpage.vendor"/></form:option>
																	...
																	<tr>
																		<th colspan="2" align="left"
																			...
																			<form:hidden path="moduleID" /> <form:hidden
																				path="filterOption" /></th>
																	</tr>
																	<tr>
																		<td style="font-size: 12px;"><spring:message
																		...
																		<td align="left" style="font-size: 12px;"><input
																			type="checkbox" name="salesOrderBoard"
																			id="salesOrderBoard"
																			value="${configDto.salesOrderBoard}"
																			${configDto.salesOrderBoard=='on'?'checked':''} /> <label><spring:message
																					code="BzComposer.configuration.defaultdashboard.opensalesorders" /></label>&nbsp;&nbsp;&nbsp;
																			...
																			<label><spring:message
																					code="BzComposer.configuration.defaultdashboard.itemreceived" /></label>&nbsp;&nbsp;&nbsp;
																			<form:checkbox path="showUSAInBillShipAddress"
																				id="showUSAInBillShipAddress" /> <label><spring:message
																					code="BzComposer.configuration.defaultdashboard.showUSAInBillShipAddress" /></label>
																			<br /> <input type="checkbox" name="poboard"
																			id="poboard" value='${configDto.poboard}'
																			${configDto.poboard=='on'?'checked':''} /> <label><spring:message
																					code="BzComposer.configuration.defaultdashboard.poboard" /></label>
																			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																			...
																			<label><spring:message
																					code="BzComposer.configuration.defaultdashboard.itemshiped" /></label>
																		</td>
																	</tr>
																</table>
															</div>
																...
																<table class="table-notifications" width="80%">
																	<tr>
																		<th colspan="3" align="left"
																			style="font-size: 12px; padding: 5px;"><spring:message
																				code="BzComposer.configuration.feturesheader" /></th>
																	</tr>
																	<tr>
																		<td style="font-size: 12px;"><b> <spring:message
																					code="BzComposer.configuration.features.availablemodules" />
																		</b></td>
																		<td>&nbsp;&nbsp;</td>
																		<td style="font-size: 12px;"><b> <spring:message
																					code="BzComposer.configuration.features.selectedmodules" />
																		</b></td>
																	</tr>
																	<tr>
																		<td width="25%" style="font-size: 12px;"><form:select
																				path="selectedModuleId" id="selectedModuleId"
																				style="width: 200px; height: 200px;font-size: 1em;"
																				class="featureName1" multiple="true">
																				<c:if
																					test="${not empty configDto.listOfExistingModules}">
																					<c:forEach
																						items="${configDto.listOfExistingModules}"
																						var="objList1">
																		...
																		<td style="font-size: 12px;"><br> <br>
																			<a class="addfeature"
																			style="cursor: pointer; border: 1px solid #000; padding: 5px; background-color: #fff">
																				<spring:message
																					code="BzComposer.configuration.lefttorightbtn" />
																		</a> <br /> <br /> <a class="removefeature"
																			style="cursor: pointer; border: 1px solid #000; padding: 5px; background-color: #fff">
																				<spring:message
																					code="BzComposer.configuration.righttoleftbtn" />
																		</a></td>
																		<td><form:select path="selectedModules"
																				id="selectedModules"
																				style="width: 200px; height: 200px;font-size: 1em;"
																				class="featureName2" multiple="true">
																				<c:if
																					test="${not empty configDto.listOfExistingselectedModules}">
																					<c:forEach
																						items="${configDto.listOfExistingselectedModules}"
																						var="objList1">
																						<option value="${objList1.selectedModuleId}">${objList1.featureName}</option>
																					</c:forEach>
																				</c:if>
														...
														<div id="companyinfo">
															<div id="content" class="tabPage">
																<form:form name="CompanyInfoForm" method="post"
																	id="frmUpdateCompany" modelAttribute="companyInfoDto">
																	<table id="companyInfoTable"
																		class="table-notifications">
																		<tr>
																			<th colspan="3" style="padding: 5px;"><spring:message
																					code="BzComposer.companyinfo.title" /></th>
																		</tr>
																		<tr>
																		...
																		<tr>
																			<td style="width: 30%;"><spring:message
																					code="BzComposer.register.membershiplevels" /> <span
																				class="inputHighlighted"><spring:message
																						code="BzComposer.CompulsoryField.Validation" /></span></td>
																			<td style="width: 30%;"><form:select
																					path="membershipLevel" style="width:350px;">
																		...
																		<tr>
																			<td><spring:message
																					code="BzComposer.companyinfo.emailaddress" /> <span
																				class="inputHighlighted">*</span></td>
																			<td><form:input path="email" size="42"
																					maxlength="45" /></td>
																			<td>&nbsp;</td>
																		</tr>
																		<tr>
																			<td><spring:message
																					code="BzComposer.Companyinformation.FirstName" />
																				<span class="inputHighlighted">*</span></td>
																		...
																		<tr>
																			<td><spring:message
																					code="BzComposer.Companyinformation.LastName" /> <span
																				class="inputHighlighted">*</span></td>
																		...
																		<tr>
																			<td><spring:message
																					code="BzComposer.register.jobposition" /> <span
																				class="inputHighlighted">*</span></td>
																			<td><form:select path="jobPosition"
																					style="width:350px;">
																					<form:option value="president">
																						<spring:message
																							code="BzComposer.register.president" />
																					</form:option>
																					<form:option value="manager">
																						<spring:message code="BzComposer.register.manager" />
																					</form:option>
																					<form:option value="programmer">
																						<spring:message
																							code="BzComposer.register.programmer" />
																					</form:option>
																				</form:select></td>
																			<td>&nbsp;</td>
																		</tr>
																		<tr>
																			...
																			<td><select name="locale" id="locale"
																				...
																				style="width: 350px;">
																					<option value="en"
																						${currentLocale=='en'?'selected':''}><spring:message
																							code="BzComposer.selectlanguage.english" /></option>
																					<option value="zh"
																						${currentLocale=='zh'?'selected':''}><spring:message
																							code="BzComposer.selectlanguage.chinese" /></option>
																					<option value="es"
																						${currentLocale=='es'?'selected':''}><spring:message
																							code="BzComposer.selectlanguage.spanish" /></option>
																			</select></td>
																			<td>&nbsp;</td>
																		</tr>
																		<tr style="border-bottom: 1px solid #ccc;">
																			<td colspan="3"><strong><spring:message
																						code="BzComposer.companyinfo.aboutcompany" /></strong></td>
																		</tr>
																		<tr>
																			<td><spring:message
																					code="BzComposer.Companyinformation.CompanyName" />
																				<span class="inputHighlighted">*</span></td>
																			<td><form:input path="companyName" size="42"
																					maxlength="45" /></td>
																			<td>&nbsp;</td>
																		</tr>
																		<tr>
																			...
																			<td><form:input path="nickName" size="42"
																					maxlength="45" /></td>
																			<td>&nbsp;</td>
																		</tr>
																		<tr>
																			<td><spring:message
																					code="BzComposer.Companyinformation.Type" /> <span
																				class="inputHighlighted">*</span></td>
																			<td><form:select path="businessTypeId"
																					id="businessTypeId" style="width:350px;">
																					<c:forEach
																						items="${companyInfoDto.listOfBusinessType}"
																						var="objList1">
																		...
																		<tr>
																			<td><spring:message
																					code="BzComposer.Companyinformation.Address1" /> <span
																				class="inputHighlighted">*</span></td>
																			<td><form:input path="address1" size="42"
																					maxlength="45" /></td>
																			<td>&nbsp;</td>
																		</tr>
																		<tr>
																			<td><spring:message
																					code="BzComposer.Companyinformation.Address2" /></td>
																			<td><form:input path="address2" size="42"
																					maxlength="45" /></td>
																			<td>&nbsp;</td>
																		</tr>
																		<tr>
																			<td>
																				<div class="lblZipcodeShow">
																					<spring:message
																						code="BzComposer.companyinfo.zipcode" />
																					<span class="inputHighlighted">*</span>
																				</div>
																				<div class="lblPostalcodeShow">
																					<spring:message
																						code="BzComposer.global.postalcodes" />
																					<span class="inputHighlighted">*</span>
																				</div>
																			</td>
																			<td><form:input type="text" path="zip"
																					onfocusout="loadAddressDetailsByZipcode(this.value, 1);"
																					onkeypress="return numbersonly(event, this.value)"
																					size="42" maxlength="10" /></td>
																			<td>&nbsp;</td>
																		</tr>
																		<tr>
																			<td><spring:message
																					code="BzComposer.companyinfo.city" /> <span
																				class="inputHighlighted">*</span></td>
																		...
																		<tr>
																			<td class="lblStateShow"><spring:message
																					code="BzComposer.Customer.State" /> <span
																				class="inputHighlighted">*</span></td>
																			<td class="lblProvinceShow"><spring:message
																					code="BzComposer.Companyinformation.Province" /> <span
																				class="inputHighlighted">*</span></td>
																		...
																		<tr>
																			<td><spring:message
																					code="BzComposer.Customer.Country" /> <span
																				class="inputHighlighted">*</span></td>
																		...
																		<tr>
																			<td><spring:message
																					code="BzComposer.Companyinformation.Phone" /> <span
																				class="inputHighlighted">*</span></td>
																			<td><form:input path="phone"
																					onchange="setPhonePattern(this)" size="42"
																					maxlength="15" /></td>
																			<td>&nbsp;</td>
																		</tr>
																		<tr>
																			...
																			<td><form:input path="cellPhone"
																					onchange="setPhonePattern(this)" size="42"
																					maxlength="15" /></td>
																			<td>&nbsp;<form:checkbox
																					path="sameAsPhoneNumber"
																		...
																		<tr>
																			<td><spring:message
																					code="BzComposer.companyinfo.fax" /></td>
																		...
																		<tr>
																			...
																			<td><form:input path="taxID" size="42"
																					maxlength="15" /></td>
																			<td>&nbsp;</td>
																		</tr>
																	</table>
														...
														<div id="security">
															<div id="content" class="tabPage">
																...
																<form:form name="SecurityForm" method="post"
																	id="SecurityForm" modelAttribute="companyInfoDto">
																	<table id="companyInfoTable"
																		class="table-notifications">
																		<tr>
																			<th colspan="3"
																				style="padding: 5px; font-size: 12px;"><spring:message
																					code="BzComposer.register.security" /></th>
																		</tr>
																		<tr>
																			<td colspan="3" align="center"><div
																					id="errorsPWD" style="color: red;"></div></td>
																		</tr>
																		<tr>
																			<td style="width: 30%; font-size: 12px;"><spring:message
																					code="BzComposer.register.password" /> <span
																				class="inputHighlighted"><spring:message
																						code="BzComposer.CompulsoryField.Validation" /></span></td>
																			<td style="width: 30%; font-size: 12px;"><form:input
																					type="password" path="password" size="40"
																					maxlength="45" required="true" /></td>
																			<td style="width: 40%;">&nbsp;</td>
																		</tr>
																		<tr>
																			<td nowrap style="font-size: 12px;"><spring:message
																					code="BzComposer.register.confirmpassword" /> <span
																				class="inputHighlighted"><spring:message
																						code="BzComposer.CompulsoryField.Validation" /></span>&nbsp;
																			</td>
																			<td style="font-size: 12px;"><form:input
																					type="password" path="confirmPassword" size="40"
																					maxlength="45" required="true" /></td>
																			<td>
																				<button type="button" class="formbutton"
																...
																<form:form name="AdminSecurityForm" method="post"
																	id="form" modelAttribute="configDto">
																		...
																		<form name="changeUserName&Password">
																			<table border="2" style="width: 100%">
																				<tr>
																					<td colspan="2" align="center"
																						style="font-size: 12px; padding: 5px;"><spring:message
																							code="BzComposer.configuration.configadmin" /></td>
																				</tr>
																				<tr>
																					<td style="font-size: 14px;"><spring:message
																							code="BzComposer.configuration.username" />:</td>
																					<td style="font-size: 14px;"><form:input
																							path="emailAddress" id="modalUserName" /></td>
																				</tr>
																				<tr>
																					<td style="font-size: 14px;"><spring:message
																							code="BzComposer.configuration.oldpassword" />:</td>

																					<td style="font-size: 14px;"><form:input
																							type="password" path="password"
																							id="modalOldPassword" /></td>
																				</tr>
																				<tr>
																					<td style="font-size: 14px;"><spring:message
																							code="BzComposer.configuration.newpassword" />:</td>
																					<td style="font-size: 14px;"><form:input
																							type="password" path="newPassword"
																							id="modalNewPassword" /></td>
																				</tr>
																				<tr>
																					<td style="font-size: 14px;"><spring:message
																							code="BzComposer.configuration.confirmpassword" />:
																					</td>
																					<td style="font-size: 14px;"><form:input
																							type="password" path="newPassword"
																							id="modalConfirmPassword" /></td>
																				</tr>
																				<tr>
																					<td style="font-size: 14px;"><input
																						type="submit" class="bottomButton formButton"
																						name="Save" id="Save"
																						value='<spring:message code="BzComposer.configuration.configadminbtn"/>'
																						onclick="getData()" /></td>
																					<td style="font-size: 14px;"><a href="#"
																						rel="modal:close"> <input type="reset"
																							class="bottomButton formButton" name="Cancel"
																							id="Cancel"
																								...
																								<div>
																									<div id="table-negotiations">
																										<table>
																											<tr>
																												<td colspan="3">
																													<div id="addUserNameAndPassword"
																														style="display: block; width: 450px;">
																														<table style="font-size: 12px;">
																															<tr height="30px;">
																																<th colspan="2" align="left"><spring:message
																																		code="BizComposer.Configuration.Networking.userNameAndPassword" />
																																</th>
																															</tr>
																															<tr height="30px;">
																																<th colspan="2" align="left"><spring:message
																																		code="BizComposer.Configuration.Networking.provideUserNameAndPassword" />
																																</th>
																															</tr>
																															<tr height="30px;">
																																<td><spring:message
																																		code="BzComposer.contactus.formemail" />
																																</td>
																																<td><input type="email"
																															...
																															<tr height="30px;">
																																<td><spring:message
																																		code="Bizcomposer.confirmPassword" />
																																</td>
																																<td><input type="password"
																																	id="cpwd" style="width: 250px;">
																																</td>
																															</tr>
																															<tr height="30px;">
																																<td><spring:message
																																		code="Bizcomposer.adminPassword" /></td>
																																<td><input type="password"
																															...
																															<tr height="30px;">
																																<th colspan="2" align="left"><spring:message
																																		code="BizComposer.Configuration.Networking.selectGroupForAccessPermissions" />
																																</th>
																															</tr>
																															<tr height="30px;">
																																<td width="120px;"><spring:message
																																		code="Bizcomposer.groupName" /></td>
																																<td><form:select path="groupID"
																																		style="width:250px;">
																																		<form:options
																																			items="${configDto.listOfExistingGroup}"
																																			itemValue="selectedGroupId"
																																			itemLabel="groupName" />
																																	</form:select></td>
																															</tr>
																															<tr>
																																...
																																<td style="font-size: 14px;">
																																	<button type="button"
																																		class="formButton"
																																		onclick="viewGroupPermissions()">
																																		<spring:message
																																			code="BizComposer.Configuration.Networking.viewGroupPermissions" />
																																	</button>
																																</td>
																															</tr>
																															<tr>
																																<td colspan="2" align="right"
																																	...
																																	<button type="button"
																																		class="formButton" id="next"
																																		onclick="checkValidation()">
																																		<spring:message
																																			code="BzComposer.global.save" />
																																	</button>&nbsp;&nbsp; <input type="button"
																																	class="formButton" id="finish"
																																	value="Finish" readonly="readonly"
																																	style="display: none;"
																																	onclick="submitForm()">
																																	<button type="button"
																																		class="formButton" id="help"
																																		onclick="showHelp()">
																																		<spring:message code="BzComposer.Help" />
																																	</button>&nbsp;&nbsp; <a href="#"
																																	rel="modal:close">
																																		<button type="reset"
																																			class="formButton" name="Cancel"
																																			id="Cancel">
																																			<spring:message
																																				code="BzComposer.global.cancel" />
																																		</button>
																																</a>
																																</td>
																															</tr>
																								...
																								<div>
																									<div id="table-negotiations">
																										<table>
																											<tr>
																												<td colspan="3">
																													<div id="addUserNameAndPassword1"
																														style="display: block; width: 450px;">
																														<table style="font-size: 12px;">
																															<tr height="30px;">
																																<th colspan="2" align="left"><spring:message
																															...
																															<tr height="30px;">
																																...
																																<td><input class="diveUserEmail"
																																	type="email" name="userEmail"
																																	id="userEmail1" style="width: 250px;">
																																</td>
																															</tr>
																															<tr height="30px;">
																																<td><spring:message
																																		code="Bizcomposer.password" /></td>
																																<td><input class="divUserPassword"
																															...
																															<tr height="30px;">
																																...
																																<td><input class="divcpwd"
																																	type="password" id="cpwd1"
																																	style="width: 250px;"></td>
																															</tr>
																															<tr height="30px;">
																																<td><spring:message
																																		code="Bizcomposer.adminPassword" /></td>
																																<td><input class="divadminpassword"
																		...
																		<table class="table-notifications" width="80%">
																			<tr>
																				<th colspan="5" align="left"
																					style="font-size: 12px; padding: 5px;"><spring:message
																						code="BzComposer.configuration.administrator" />
																				</th>
																			</tr>
																			<tr>
																				<td style="font-size: 12px;"><spring:message
																				...
																				<td style="font-size: 12px;">
																					...
																					<form:input path="emailAddress" id="UserName"
																			...
																			<tr>
																				<td style="font-size: 12px;"><spring:message
																						code="BzComposer.configuration.password" /></td>
																				<td style="font-size: 12px;"><form:input
																						type="password" path="password" maxlength="30"
																				...
																				<td style="font-size: 12px;">
																					...
																					<a href="#uName" rel="modal:open">
																						<button type="button" name="changePassword"
																							class="formButton"
																			...
																			<tr>
																				<th colspan="5" align="left"
																					style="font-size: 12px; padding: 5px;"><spring:message
																						code="BzComposer.configuration.swithcusermode" />
																				</th>
																			</tr>
																			<tr>
																				<td colspan="5" style="font-size: 12px;"><form:radiobutton
																						path="multiUserConnection"
																						id="multiUserConnection1" value="0" /> <spring:message
																						code="BzComposer.configuration.usermode.singleusermode" />
																				</td>
																			</tr>
																			<tr>
																				<td colspan="5" style="font-size: 12px;"><form:radiobutton
																						path="multiUserConnection"
																						id="multiUserConnection2" value="1" /> <spring:message
																						code="BzComposer.configuration.usermode.multiusermode" />
																				</td>
																			</tr>
																			<tr id="userlistlable11">
																				<th colspan="5" align="left"
																					style="font-size: 12px; padding: 5px;"><spring:message
																						code="BzComposer.configuration.userlist" /></th>
																			</tr>
																			<tr>
																					...
																					<div style="overflow: auto; height: 200;"
																						...
																						<table cellspacing="0" border="1"
																							...
																							<thead>
																								<tr>
																									<td><b><spring:message
																												code="BzComposer.configuration.username" /></b></td>
																									<td><b><spring:message
																												code="BzComposer.configuration.password" /></b></td>
																									<td><b><spring:message
																												code="BzComposer.configuration.groupname" /></b></td>
																									<td><b><spring:message
																												code="BzComposer.configuration.status" /></b></td>
																								</tr>
																							</thead>
																							<tbody>
																								<c:if
																									test="${not empty configDto.listOfExistingUserList}">
																									<input type="hidden" id="usersSize"
																										value='${configDto.listOfExistingUserList.size()}' />
																									<c:forEach
																										items="${configDto.listOfExistingUserList}"
																										var="objList1" varStatus="loop">
																										<tr id='${loop.index}usrIndex'
																											onclick="selectUserData('${objList1.upsUserId}', '${objList1.groupID}', '${objList1.emailAddress}', '${objList1.password}', '${objList1.groupName}','${objList1.status}', '${loop.index}usrIndex');">
																				...
																				<td colspan="2" align="center" valign="middle"
																					...
																					<button type="button" class="formButton"
																						onclick="adduser1();" style="width: 120px;">
																						<spring:message
																							code="BzComposer.configuration.adduserbtn" />
																					</button> <br /> <br />
																					<button type="button" class="formButton"
																						style="width: 120px;" onclick="updateUser();">
																						<spring:message
																							code="BzComposer.configuration.savechangesbtn" />
																					</button> <br /> <br />
																					<button type="button" class="formButton"
																						onclick="Deleteuser();" style="width: 120px;">
																			...
																			<tr id="userlistlable11">
																				<th colspan="5" align="left"
																					style="font-size: 12px; padding: 5px;"><spring:message
																						code="BizComposer.Configuration.groupList" /></th>
																			</tr>
																			<tr>
																				<td colspan="3" style="font-size: 12px;">
																					<div style="overflow: auto; height: 200;"
																						...
																						<table cellspacing="0" border="1"
																							...
																							<tbody>
																								<c:if
																									test="${not empty configDto.listOfExistingGroup}">
																									<input type="hidden" id="groupSize"
																										value='${configDto.listOfExistingGroup.size()}' />
																									<c:forEach
																										items="${configDto.listOfExistingGroup}"
																										var="objList1" varStatus="loop">
																										<tr id='${loop.index}gpIndex'
																											onclick="selectGroupData('${objList1.selectedGroupId}', '${loop.index}gpIndex');">
																											<td>${objList1.groupName}</td>
																											<td>${objList1.status}</td>
																										</tr>
																									</c:forEach>
																				...
																				<td colspan="2" align="center" valign="middle"
																					...
																					<button type="button" class="formButton"
																						style="width: 120px;" onclick="addNewGroup()">
																						<spring:message
																							code="BzComposer.configuration.addgroupbtn" />
																					</button> <br /> <br />
																					<button type="button" class="formButton"
																						style="width: 120px;" onclick="editGroup()">
																						<spring:message
																							code="BzComposer.configuration.editgroupbtn" />
																					</button> <br /> <br />
																					<button type="button" class="formButton"
																						style="width: 120px;">
																						<spring:message
																					...
																					<button type="button" class="formButton"
																						style="width: 120px;" onclick="deleteGroup()">
																						<spring:message code="BzComposer.global.delete" />
																					</button>
																				</td>
																			</tr>
																	...
																	<div>
																		...
																		<input type="hidden" name="selectedUserId"
																			id="selectedUserId" /> <input type="hidden"
																			name="userGroupId" id="userGroupId" />
																	</div>
																</form:form>
																<!-- Admin-Security End -->
															</div>
