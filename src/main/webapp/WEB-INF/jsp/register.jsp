...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/scripts/myAppUtility.js"></script>
...
#table-negotiations table tbody tr td input, #table-negotiations table tbody tr td select
	{
	width: 304px;
	height: 32px;
	border-radius: 0;
...
<script type="text/javascript">
	...
	$(document).ready(
			function() {
				$("#countryID").change(
						function() {
							var countryId = document
									.getElementById("countryID").value;
							let countryCode = $("#countryID").find(
						...
						<div class="row">
							<div class="col-md-3" align="center">
								<div class="logo" style="max-width: 100%;">
									<a href="#" onclick="goToHomePage()"> <img
								...
								<div class="search-wrap" align="right">
									<div class="input-group" align="center">
										<input type="text" id="searchBox" name="searchBox"
											placeholder="<spring:message code="BzComposer.searchtext"/>"
											style="max-width: 100%;" />
							...
							<div class="col-md-3" align="center">
								<div class="input-group">
									<select name="localeMobile" id="localeMobile"
										class="form-control" onchange="showLocaleMobile();">
										<!-- <option value=""><spring:message code="BzComposer.selectlanguage"/></option> -->
										<option value="en" ${currentLocale=='en'?'selected':''}><spring:message
												code="BzComposer.selectlanguage.english" /></option>
										<option value="zh" ${currentLocale=='zh'?'selected':''}><spring:message
												code="BzComposer.selectlanguage.chinese" /></option>
										<option value="es" ${currentLocale=='es'?'selected':''}><spring:message
							...
							<div class="col-md-3" align="center">
								<div align="center">
									<div class="contact-widget contact-widget-1">
										...
										<button type="button" class="btn btn-primary">
											<spring:message code="BzComposer.register" />
										</button>
									</div>
								</div>
							</div>
			...
			<form:form action="/addUserMember" method="post" name="MultiUserForm"
				...
				<div class="container">
					<div id="table-negotiations"
						style="width: 70%; margin: 0px auto; margin-top: 30px; float: left;">
						<h2>
							<spring:message code="BzComposer.register.title" />
						</h2>
						<table
							style="width: 100%; border: 1px solid lightgray; padding: 20px; margin-bottom: 10px;"
							cellspacing="10">
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>
							...
							<tr>
								<td colspan="3" class="sub_heading">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.membership" />
								</td>
							</tr>
							<tr>
								<td colspan="3"><hr></td>
							...
							<tr>
								<td style="width: 25%;">&nbsp;&nbsp;<spring:message
								...
								<td style="width: 50%;"><form:select path="membershipLevel">
										...
										<form:option value="standard">
											<spring:message code="BzComposer.register.standardmembership" />
										</form:option>
										...
										<form:option value="eSales">
											<spring:message code="BzComposer.register.esalesmembership" />
										</form:option>
									</form:select></td>
							...
							<tr>
								<td colspan="3" class="sub_heading">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.aboutyou" />
								</td>
							</tr>
							<tr>
								<td colspan="3"><hr></td>
							...
							<tr>
								<td id="t_txtFirstName">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.firstname" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
								<td class="inputfild"><form:input type="text"
										path="firstName" required="true" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td id="t_txtLastName">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.lastname" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
								<td class="inputfild"><form:input type="text"
							...
							<tr>
								...
								<td class="select_option"><form:select path="jobPosition">
										...
										<form:option value="president">
											<spring:message code="BzComposer.register.president" />
										</form:option>
										<form:option value="manager">
											<spring:message code="BzComposer.register.manager" />
										</form:option>
										<form:option value="programmer">
											<spring:message code="BzComposer.register.programmer" />
										</form:option>
									</form:select></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td id="t_email">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.emailaddress" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
								<td class="inputfild"><form:input type="email"
										path="emailAddress" required="true" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td colspan="3" class="sub_heading">&nbsp;&nbsp;<spring:message
							...
							<%-- <tr>
								<td id="t_uname" width="40%">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.loginname" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
								<td class="inputfild"><form:input type="text"
							...
							<tr>
								<td id="t_password">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.password" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
								<td class="inputfild"><form:input type="password"
										path="password" required="true" /></td>
								<td align="center">
									<div class="tooltip">
										<img src="images/q.gif" border="0" width="20" height="20">
										<span class="tooltiptext">Your password is case
											sensitive and must be between 6 and 16 characters in length.</span>
									</div>

								</td>
							</tr>
							<tr>
								<td id="t_password_copy" nowrap>&nbsp;&nbsp;<spring:message
										code="BzComposer.register.confirmpassword" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>&nbsp;
								</td>
								<td class="inputfild"><form:input type="password"
										path="confirmPassword" required="true" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td colspan="3" class="sub_heading">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.aboutcompany" />
								</td>
							</tr>
							<tr>
								<td colspan="3"><hr></td>
							...
							<tr>
								<td id="t_txtCompanyName">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.companyname" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
								<td class="inputfild"><form:input type="text"
										path="companyName" required="true" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td id="t_txtCompanyName">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.companynickname" /> <span
							...
							<tr>
								<td id="t_txtAddress1">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.addressone" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
								<td class="inputfild"><form:input type="text"
										path="address1" style="width: 370px;" required="true" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td id="t_txtAddress2">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.addresstwo" /> <span
									class="inputHighlighted"></span>
								</td>
								<td class="inputfild"><form:input type="text"
										path="address2" style="width: 370px;" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								...
								<td class="inputfild"><form:input type="text" path="zip"
										required="true"
							...
							<tr>
								<td id="t_txtcity">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.city" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
							...
							<tr>
								<td class="lblStateShow">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.state" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
								<td class="lblProvinceShow">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.province" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
							...
							<tr>
								<td id="t_lbCountry">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.counry" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
							...
							<tr>
								<td id="t_txtPhone">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.phone" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
								<td class="select_option join_us_phoneWrap">
									<div class="join_us_phone">
										...
										<form:input type="tel" path="phone" minlength="10"
											maxlength="14"
											onchange="validateUSAPhoneNumber(this, false);"
							...
							<tr>
								<td id="t_txtMobile">&nbsp;&nbsp;<spring:message
										code="BzComposer.global.mobileNumber" />
								</td>
								<td class="select_option join_us_phoneWrap">
									<div class="join_us_phone">
										...
										<form:input type="tel" path="cellPhone" minlength="10"
											maxlength="14"
											onchange="validateUSAPhoneNumber(this, false);"
											onkeypress="return numbersonly(event, this.value);"
											required="true" />
								...
								<td class="inputfild"><form:checkbox
										path="sameAsPhoneNumber"
										style="width: 20px;vertical-align: middle;" /> (<spring:message
										code="BzComposer.global.isPhoneNumber" />)</td>
							</tr>
							<tr>
								<td id="t_txtFax">&nbsp;&nbsp;<spring:message
										code="BzComposer.register.fax" /> <span
									class="inputHighlighted"></span>
								</td>
								<td class="inputfild"><form:input type="text" path="fax" />
								</td>
								<td>&nbsp;</td>
							</tr>
							<!-- business type -->
							<tr>
								<td id="t_lbBusinessType">&nbsp;&nbsp;<spring:message
										code="BzComposer.Companyinformation.Type" /> <span
									class="inputHighlighted"><spring:message
											code="BzComposer.CompulsoryField.Validation" /></span>
								</td>
								<td class="select_option"><form:select
										path="businessTypeID" id="businessTypeID" required="true">
										<form:option value="0">
											<spring:message code="BzComposer.Companyinformation.Type" />
										</form:option>
										<c:forEach items="${businessType}" var="curObject">
											<form:option data-code="${curObject.businessTypeID}"
                ...
                <tr>
							...
							<tr>
								...
								<td id="t_captcha">
									<div class="g-recaptcha"
										data-sitekey="6LdYG_YbAAAAABCyLjdCmVFrlS6rkKpHosXfMMoH"></div>
									<span class="msg-error" id="captchaResponse"></span> <br />
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								...
								<td align="center">
									<button type="submit" class="formButton">
										<spring:message code='BzComposer.global.submit' />
									</button> &nbsp;&nbsp;&nbsp;
					...
					<div
						style="margin: 0px auto; margin-top: 50px; float: right; margin-bottom: 50px;">
						<div style="width: 300px; border: 1px solid lightgray;">
							<a href="https://www.joyofrelax.com/" target="_blank"
								rel="noopener noreferrer"> <img
								src="${pageContext.request.contextPath}/dist/template/images/loginBnA.png"
								style="width: 300px; display: block;"></a>
						</div>
						<div style="width: 300px; border: 1px solid lightgray;">
							<a href="https://www.ceragemusa.net" target="_blank"
								rel="noopener noreferrer"> <img
								src="${pageContext.request.contextPath}/dist/template/images/loginBnB.png"
								style="width: 300px; display: block;"></a>
						</div>
						<div style="width: 300px; border: 1px solid lightgray;">
							<a href="https://www.biomatplus.com/" target="_blank"
								rel="noopener noreferrer"> <img
								src="${pageContext.request.contextPath}/dist/template/images/loginBnC.png"
								style="width: 300px; display: block;"></a>
						</div>
					</div>
				</div>
