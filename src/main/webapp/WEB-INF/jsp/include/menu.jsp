...
<div id="menubar2" style="width: 100%; float: left; display: none;"
	class="header-section">
	<div class="bzclogo">
		<ul class="sf-menu" id="example"
			style="text-align: center; width: max-content;">
			<li><a href="Dashboard?tabid=Dashboard" style="cursor: pointer;"
				class="uppercaseText"><spring:message code="BzComposer.File" /></a>
				<ul>
					<li><a href="Dashboard?tabid=Dashboard"
						style="cursor: pointer;"> <span><spring:message
									code="BzComposer.Dashboard" /></span></a></li>
					<!--  <li>
					...
					<li><a href="SalesBord?tabid=ShowList"
						style="cursor: pointer;"> <span><spring:message
									code="menu.file.PrintMultipleInvoice" /></span>
					</a></li>
					<li><a href="#" style="cursor: pointer;"> <span><spring:message
									code="menu.file.Import" /></span>
					</a>
						<ul>
							<li><a href="#" onclick="confugurationImport()"
								style="cursor: pointer;"><spring:message
										code="BzComposer.Confuguration" /></a></li>
							<li><a href="#" onclick="customerImport()"
								style="cursor: pointer;"><span><spring:message
											code="BzComposer.customer.Customers" /></span></a></li>
							<li><a href="#" onclick="leadsImport()"
								style="cursor: pointer;"><span><spring:message
											code="BzComposer.lead.leads" /></span></a></li>
							<li><a href="#" onclick="vendorImport()"
								style="cursor: pointer;"><span><spring:message
											code="BzComposer.vendor.vendors" /></span></a></li>
							<li><a href="#" onclick="uploadItem()"
								style="cursor: pointer;"><span><spring:message
											code="NavigationTree.Items" /></span></a></li>
							<li><a href="#" style="cursor: pointer;"><span><spring:message
											code="BzComposer.common.orders" /> > </span></a>
								<ul>
									<li><a href="#" onclick="invoicesImport()"
										style="cursor: pointer;"><spring:message
												code="BzComposer.sales.Invoice" /></a></li>
									<li><a href="#" onclick="estimationImport()"
										style="cursor: pointer;"><spring:message
												code="BzComposer.sales.Estimation" /></a></li>
									<li><a href="#" onclick="salesOrderImport()"
										style="cursor: pointer;"><spring:message
												code="BzComposer.sales.SalesOrder" /></a></li>
									<li><a href="#" onclick="purchaseOrderImport()"
										style="cursor: pointer;"><spring:message
												code="BzComposer.purchase.PurchaseOrder" /></a></li>
								</ul></li>
						</ul></li>
					<li><a href="#" style="cursor: pointer;"> <span><spring:message
									code="menu.file.ExportTo" /></span>
					</a>
						<ul>
							<li><a href="#" onclick="exportConfiguration()"
								style="cursor: pointer;"><spring:message
										code="BzComposer.Confuguration" /></a></li>
							<li><a href="#" onclick="exportCustomer()"
								style="cursor: pointer;"><spring:message
										code="BzComposer.customer.Customers" /></a></li>
							<li><a href="#" onclick="exportLead()"
								style="cursor: pointer;"><spring:message
										code="BzComposer.lead.leads" /></a></li>
							<li><a href="#" onclick="exportVendor()"
								style="cursor: pointer;"><spring:message
										code="BzComposer.vendor.vendors" /></a></li>
							<li><a href="#" onclick="exportItem()"
								style="cursor: pointer;"><spring:message
										code="NavigationTree.Items" /></a></li>
							<li><a href="#" style="cursor: pointer;"><span><spring:message
											code="BzComposer.common.orders" /> > </span></a>
								<ul>
									<li><a href="/dataExportAction?tabid=Invoices"
										style="cursor: pointer;"><spring:message
												code="BzComposer.sales.Invoice" /></a></li>
									<li><a href="/dataExportAction?tabid=Estimations"
										style="cursor: pointer;"><spring:message
												code="BzComposer.sales.Estimation" /></a></li>
									<li><a href="/dataExportAction?tabid=SalesOrders"
										style="cursor: pointer;"><spring:message
												code="BzComposer.sales.SalesOrder" /></a></li>
									<li><a href="/dataExportAction?tabid=PurchaseOrders"
										style="cursor: pointer;"><spring:message
												code="BzComposer.purchase.PurchaseOrder" /></a></li>
								</ul></li>
							<!-- <li>
					...
					<li>
					<li><a href="#" onclick="quickBookImport()"
						style="cursor: pointer;"> <spring:message
								code="menu.file.QBImport" />
					</a></li></li>
			<li><a href="#" onclick="orderImport()" style="cursor: pointer;">
					<spring:message code="menu.file.Order_Import" />
			</a></li>
			</li>
			<li><a href="#ex1" rel="modal:open"> <span><spring:message
							code="menu.file.Calculator" /></span>
			</a></li>
			<!-- <li>
			...
			<li><a href="./Logout" style="cursor: pointer;"> <span><spring:message
							code="menu.file.Exit" /></span>
			</a></li>
		</ul>
		</li>
		<!-- LEADS START -->
		...
		<li><a href="Leads?tabid=leadList" title="Lead"
			class="uppercaseText"> <span><spring:message
						code="BzComposer.sales.Lead" /></span>
		</a>
			<ul>
				<li><a href="Leads?tabid=leadList" title="Lead"> <span><spring:message
								code="BzComposer.sales.LeadList" /></span>
				</a></li>
				<li><a href="LeadBoard?tabid=LeadBoard" title="Lead Board">
						<span><spring:message code="BzComposer.sales.LeadBoard" /></span>
				</a></li>
				<li><a
					href="${pageContext.request.contextPath}/leadAddressLabel"
					title="Print AddressLabel"> <span><spring:message
								code="BzComposer.customer.LeadAddressLabels" /></span>
				</a></li>
			</ul></li>
		<!-- LEADS END -->

		<li><a href="Customer?tabid=Customer" title="Customer"
			class="uppercaseText"> <span><spring:message
						code="BzComposer.customer.Account" /></span>
		</a>
			<ul>
				<!-- <li>
				...
				<li><a href="Customer?tabid=Customer" title="Customer"> <span><spring:message
								code="BzComposer.sales.CustomerList" /></span>
				</a></li>
				<li><a href="Customer?tabid=CustomerBoard"
					title="Customer Board"> <span><spring:message
								code="BzComposer.sales.CustomerBoard" /></span>
				</a></li>
				<li><a href="Customer?tabid=ContactBoard" title="Contact Board">
						<span><spring:message code="BzComposer.sales.ContactBoard" /></span>
				</a></li>
				<li><a href="Customer?tabid=PrintLabels"
					title="Print AddressLabel"> <span><spring:message
								code="BzComposer.customer.CustomerAddressLabels" /></span>
				</a></li>
			</ul></li>
		<li><a href="Invoice?tabid=Invoice" title="Sales"
			class="uppercaseText"> <spring:message code="BzComposer.Sales" />
		</a>
			<ul>
				<li><a href="Invoice?tabid=Invoice" title=""> <span><spring:message
								code="BzComposer.sales.Invoice" /></span>
				</a></li>
				<li><a href="Estimation?tabid=Estimation" title="Estimation">
						<span> <spring:message code="BzComposer.sales.Estimation" />
					</span>
				</a></li>
				<li><a href="SalesOrder?tabid=SalesOrder" title="salesorder">
						<span> <spring:message code="BzComposer.sales.SalesOrder" />
					</span>
				</a></li>
				<li><a href="SalesBord?tabid=ShowList" title="invoiceboard">
						<span> <spring:message code="BzComposer.sales.InvoiceBoard" />
					</span>
				</a></li>
				<li><a href="EstimationBoard?tabid=ShowList"
					title="EstimationBoard"> <span> <spring:message
								code="BzComposer.sales.EstimationBoard" />
					</span>
				</a></li>
				<li><a href="SalesOrderBoard?tabid=ShowList"
					title="salesorderboard"> <span> <spring:message
								code="BzComposer.sales.SalesOrderBoard" />
					</span>
				</a></li>
				<li class="current"><a href="javascript: void(0)" title="RMA">
						<span><spring:message code="BzComposer.RMA" /></span>
				</a>
					<ul>
						<li class="current">
							<!-- <a href="<%= session.getAttribute("path")%>/SalesBord?tabid=ShowList"> -->
							<a href="SalesBord?tabid=ShowList"> <spring:message
									code="BzComposer.RMA.CreateRma" />
						</a>
						</li>
						<li>
							<!-- <a href="<%= session.getAttribute("path")%>/RMA?tabid=R0L0S0"> -->
							<a href="RMA?tabid=R0L0S0"> <spring:message
									code="BzComposer.RMA.RMAList" />
						</a>
						</li>
						<li><a href="RMA?tabid=CreditMemo"><spring:message
									code="BzComposer.common.creditMemo" /></a></li>
					</ul></li>
				<li><a href="DataManager?tabid=datamanager" title="DataManager">
		...
		<%--				</a>--%>
		<%--			</li>--%>
		<li><a href="retail-pos" title="Item" class="uppercaseText">
				<span><spring:message code="BzComposer.pos" /></span>
		</a>
			<ul>
				<li><a href="retail-pos" title="Retail POS"> <span>
		...
		<!-- POS END -->
		<li><a href="Item?tabid=Item" title="Item" class="uppercaseText">
			...
			<ul>
				...
				<li><a href="Item?tabid=Item" title="Item List"> <span>
							<spring:message code="BzComposer.Item.ItemList" />
					</span>
				</a></li>
				<li><a href="PurchaseBoard?tabid=ShowReceivedItems"> <spring:message
							code="BzComposer.Purchase.ReceivedItem" />
				</a></li>
				<li><a href="Item?tabid=AdjustInventory"
					title="Adujust Inventory"> <span><spring:message
								code="BzComposer.Item.AdjustInventory" /></span>
				</a></li>
				<li><a href="ItemCategoryManager?tabid=ItemCategoryManager"><span><spring:message
								code="BzComposer.categorymanager.itemcategorymanager" /></span></a></li>

			</ul></li>
		<li><a href="Vendor?tabid=VONODO" title="Purchase"
			class="uppercaseText"><span><spring:message
						code="BzComposer.Purchase" /></span></a>
			<ul>
				<li><a href="Vendor?tabid=VONODO"><spring:message
							code="BzComposer.vendor.vendors" /></a></li>
				<!-- <li><a href="Vendor?tabid=AODOVO"><spring:message code="BzComposer.vendor.AddNewCutomer" /></a></li> -->
				<li><a href="PrintLBL?tabid=PrintLabel"><spring:message
							code="BzComposer.vendor.VendorAddressLabels" /></a></li>
				<li><a href="PurchaseOrder?tabid=PurchaseOrder"
					title="Purchase"> <span><spring:message
								code="BzComposer.purchase.PurchaseOrder" /></span>
				</a></li>
				<li><a href="PurchaseBoard?tabid=ShowList" title=""> <span><spring:message
								code="BzComposer.purchase.Purchase.PurchaseBoard" /></span>
				</a></li>
				<!-- <li>
		...
		<li><a href="Banking?tabid=Banking" title="Accounting"
			style="cursor: pointer;" class="uppercaseText"> <spring:message
					code="BzComposer.Accounting" />
		</a>
			<ul>
				<!-- <li>
				...
				<li><a href="Banking?tabid=Banking" title="Banking"> <span><spring:message
								code="BzComposer.Banking" /></span>
				</a></li>
				<li>
					...
					title="AccountReceiveble"> <span><spring:message
								code="BzComposer.AccountReceiveble" /></span>
				</a>
				</li>
				<li><a href="BillingBoard?tabid=billingBoard"
					title="BillingBoard"> <span><spring:message
								code="BzComposer.BillingBoard" /></span>
				</a></li>
				<li><a href="PoPayable?tabid=popayable" title="PoPayable">
						<span><spring:message
								code="BzComposer.popayable.payabletitle" /></span>
				</a></li>
				<li><a href="BillPayable?tabid=billpayable" title="BillPayable">
						<span><spring:message code="BzComposer.Billpayable" /></span>
				</a></li>
				<li><a href="Reconsilation?tabid=reconsilation"
					style="cursor: pointer;"> <span><spring:message
								code="BzComposer.Reconsilation" /></span>
				</a></li>
				<li><a href="CategoryDetail?tabid=categoryDetail"
					style="cursor: pointer;"> <span><spring:message
								code="BzComposer.CategoryDetail" /></span>
				</a></li>
			</ul></li>
		<!-- <li>
		...
		<li><a href="Reports?tabid=ReportsCenter" title="Report Center"
			class="uppercaseText"> <span><spring:message
			...
			<ul>
				...
				<li><a href="javascript: void(0)"> <span> <spring:message
								code="BzComposer.reportcenter.customerandreceivables" />
					</span>
				</a>
					<ul>
						<li><a href="#" onclick="ShowCustomerList()"> <spring:message
									code="BzComposer.reportcenter.listing.customerlist" />
						</a></li>
						<li><a href="#" onclick="ShowCustomerPhoneList()"> <spring:message
									code="BzComposer.reportcenter.listing.customerphonelist" />
						</a></li>
						<li><a href="#" onclick="ShowCustomerContactList()"> <spring:message
									code="BzComposer.reportcenter.listing.customercontactlist" />
						</a></li>
						<li><a href="#" onclick="ShowTrancsactionbylistCustomer()">
								<spring:message
									code="BzComposer.reportcenter.listing.transactionlistbycustomer" />
						</a></li>
						<li><a href="#" onclick="ShowCustomerBalSummary()"> <spring:message
									code="BzComposer.reportcenter.balance.customerbalancesummary" />
						</a></li>
						<li><a href="#" onclick="ShowCustomerBalDetail()"> <spring:message
									code="BzComposer.reportcenter.balance.customerbalancedetail" />
						</a></li>
						<li><a href="#" onclick="ShowCustomerList()"> <spring:message
									code="BzComposer.reportcenter.sales.salesbycustomerdetails" />
						</a></li>
						<li><a href="#" onclick="ShowSalesByCustomerSummary()"> <spring:message
									code="BzComposer.reportcenter.sales.salesbycustomersummary" />
						</a></li>
						<li><a href="#" onclick="ShowIncomeCustomerSummary()"> <spring:message
									code="BzComposer.reportcenter.income.incomebycustomersummary" />
						</a></li>
						<li><a href="#" onclick="ShowIncomeCustomerDetail()"> <spring:message
									code="BzComposer.reportcenter.income.incomebycustomerdetail" />
						</a></li>
					</ul></li>
				<li><a href="javascript: void(0)"> <span> <spring:message
								code="BzComposer.Sales" />
					</span>
				</a>
					<ul>
						<li><a href="#" onclick="showSalesReport('SalesRBC');"> <spring:message
									code="BzComposer.reportcenter.sales.salesreportbycustomer" />
						</a></li>
						<li><a href="#" onclick="showSalesReport('SalesRID');"> <spring:message
									code="BzComposer.reportcenter.sales.salesbyitem" />
						</a></li>
						<li><a href="#" onclick="showSalesReport('SalesRBI');"> <spring:message
									code="BzComposer.reportcenter.sales.salesreportbyitem" />
						</a></li>
						<li><a href="#" onclick="showInvoiceList('AllInvoice');">
								<spring:message
									code="BzComposer.reportcenter.creditrefund.allcreditrefundsalesreport" />
						</a></li>
						<li><a href="#" onclick="showInvoiceList('PaidInvoice');">
								<spring:message
						...
						<li><a href="#" onclick="showInvoiceList('UnPaidInvoice');">
								<spring:message code="BzComposer.Report.UnPaidInvoice" />
						</a></li>
						<li><a href="#" onclick="showEstimationList()"> <spring:message
									code="BzComposer.reportcenter.estimation.allestimation" />
						</a></li>
					</ul></li>
				<li><a href="javascript: void(0)"> <span><spring:message
								code="BzComposer.Report.ItemInventory" /></span>
				</a>
					<ul>
						<li><a href="#" onclick="showInventoryList();"> <spring:message
									code="BzComposer.Report.InventoryList" />
						</a></li>
						<li><a href="#" onclick="showReceivedItemList();"> <spring:message
									code="BzComposer.reportcenter.listing.receivedItemList" />
						</a></li>
						<li><a href="#" onclick="showReservedInventoryList();"> <spring:message
									code="BzComposer.Report.ReservedInventoryList" />
						</a></li>
						<li><a href="#" onclick="showItemPriceList();"> <spring:message
									code="BzComposer.Report.ReservedInventoryList.ItemPriceList" />
						</a></li>
						<li><a href="#" onclick="showDiscontinuedInventoryList();">
								<spring:message
									code="BzComposer.Report.Discontinued.InventoryList" />
						</a></li>
						<li><a href="#" onclick="showDamageInventoryList();"> <spring:message
									code="BzComposer.reportcenter.listing.damageinventorylist" />
						</a></li>
						<li><a href="#" onclick="MissingInventoryList();"> <spring:message
									code="BzComposer.reportcenter.listing.missinginventorylist" />
						</a></li>
						<li><a href="#" onclick="ReturnInventoryList();"> <spring:message
									code="BzComposer.reportcenter.listing.returninventorylist" />
						</a></li>
						<li><a href="#" onclick="showDamagedInventoryList();"> <spring:message
						...
						<li><a href="#" onclick="showUnknownInventoryList();"> <spring:message
									code="BzComposer.reportcenter.listing.unknowninventorylist" />
						</a></li>
						<li><a href="#" onclick="showReturnedInventoryList();"> <spring:message
									code="BzComposer.reportcenter.listing.returnedinventorylist" />
						</a></li>
						<li><a href="#" onclick="showDailyItemSummary();"> <spring:message
									code="BzComposer.reportcenter.listing.dailyitemsummary" />
						</a></li>
						<li><a href="#" onclick="showDailySalesSummary();"> <spring:message
									code="BzComposer.reportcenter.listing.dailysalessummary" />
						</a></li>
						<li><a href="#" onclick="showInvValSummary();"> <spring:message
									code="BzComposer.reportcenter.valuation.inventoryvaluationsummary" />
						</a></li>
						<li><a href="#" onclick="showInvValDetail();"> <spring:message
									code="BzComposer.reportcenter.valuation.inventoryvaluationdetail" />
						</a></li>
						<li><a href="#" onclick="showInvOrderReport();"> <spring:message
									code="BzComposer.reportcenter.inventoryorder.inventoryorderreport" />
						</a></li>
						<li><a href="#" onclick="showInvStatistic();"> <spring:message
									code="BzComposer.reportcenter.inventorystatistics.currentinventorystatictics" />
						</a></li>
					</ul></li>
				<li><a href="javascript: void(0)"> <span><spring:message
								code="BzComposer.Report.VendorPurchase" /></span>
				</a>
					<ul>
						<li><a href="#" onclick="ShowvendorList();"> <spring:message
									code="BzComposer.Report.VendorList" />
						</a></li>
						<li><a href="#" onclick="ShowvendorPhoneList()"> <spring:message
									code="BzComposer.Report.VendorPhoneList" />
						</a></li>
						<li><a href="#" onclick="ShowVendorContactList();"> <spring:message
									code="BzComposer.Report.VendorContactList" />
						</a></li>
						<li><a href="#" onclick="ShowsvendorBalanceDetails();"> <spring:message
									code="BzComposer.Report.vendor.BalanceDetails" />
						</a></li>
						<li><a href="#" onclick="ShowsvendorBalanceSymmary();"> <spring:message
									code="BzComposer.reportcenter.balance.vendorbalancesummary" />
						</a></li>
						<li><a href="#" onclick="ShowsAllPurchaseorders();"> <spring:message
									code="BzComposer.Report.PurchaseOrders" />
						</a></li>
						<li><a href="#" onclick="ShowAllPurchaseBills();"> <spring:message
									code="BzComposer.reportcenter.allpurchasebills" />
						</a></li>
						<li><a href="#" onclick="ShowPaidPurchaseBills();"> <spring:message
									code="BzComposer.reportcenter.paidpurchasebills" />
						</a></li>
						<li><a href="#" onclick="ShowUnPaidPurchaseBills();"> <spring:message
									code="BzComposer.reportcenter.unpaidpurchasebills" />
						</a></li>
						<li><a href="#" onclick="ShowCancelledPurchaseRefBill();">
								<spring:message
									code="BzComposer.reportcenter.cancelledpurchasebillrefundlist" />
						</a></li>
						<li><a href="#" onclick="ShowVendor1099List();"> <spring:message
									code="BzComposer.reportcenter.vendor1099list" />
						</a></li>
						<li><a href="#" onclick="Vendor1099TransactionSummary();">
								<spring:message
									code="BzComposer.reportcenter.vendor1099transactionsummary" />
						</a></li>
						<li><a href="#" onclick="vendor1099TransactionDetail();">
								<spring:message
									code="BzComposer.reportcenter.vendor1099transactiondetail" />
						</a></li>
					</ul></li>
				<li><a href="javascript: void(0)"> <span><spring:message
								code="BzComposer.Report.Employee" /></span>
				</a>
					<ul>
						<li><a href="#" onclick="ShowEmployeeSalesByRep();"> <spring:message
									code="BzComposer.Report.Employee.SalesByRepDetails" />
						</a></li>
						<li><a href="#" onclick="ShowEmployeeSalesReportByRep();">
								<spring:message
									code="BzComposer.Report.Employee.SalesReportByRep" />
						</a></li>
					</ul></li>
				<li><a href="javascript: void(0)"> <span><spring:message
								code="BzComposer.reportcenter.bankingandaccounting" /></span>
				</a>
					<ul>
						<li><a href="#" onclick="ShowCheckDetail();"> <spring:message
									code="BzComposer.reportcenter.bankingandtransactiondetail.checkdetail" />
						</a></li>
						<li><a href="#" onclick="ShowDepositDetail();"> <spring:message
									code="BzComposer.reportcenter.bankingandtransactiondetail.depositdetail" />
						</a></li>
						<li><a href="#" onclick="ShowBillDetail();"> <spring:message
									code="BzComposer.reportcenter.bankingandtransactiondetail.billdetail" />
						</a></li>
						<li><a href="#" onclick="TransactionDeatail();"> <spring:message
									code="BzComposer.reportcenter.bankingandtransactiondetail.transactiondeatails" />
						</a></li>
						<li><a href="#" onclick="ShowAccountReceivableGraph();">
								<spring:message
									code="BzComposer.reportcenter.graph.accountreceivablegraph" />
						</a></li>
						<li><a href="#" onclick="ShowAccountReceivable();"> <spring:message
									code="BzComposer.reportcenter.account.accountreceivable" />
						</a></li>
						<li><a href="#" onclick="ShowAccountPayable();"> <spring:message
									code="BzComposer.reportcenter.accountpayable" />
						</a></li>
						<li><a href="#" onclick="AccountPayableGraph();"> <spring:message
									code="BzComposer.reportcenter.accountpayablegraph" />
						</a></li>
					</ul></li>
				<li><a href="javascript: void(0)"> <span><spring:message
								code="BzComposer.reportcenter.profitandbudget" /></span>
				</a>
					<ul>
						<li><a href="#" onclick="ShowProfitLoss();"> <spring:message
									code="BzComposer.reportcenter.profitorloss.profitlossstandard" />
						</a></li>
						<li><a href="#" onclick="ShowProfitLossDetail();"> <spring:message
									code="BzComposer.reportcenter.profitorloss.profitlossdetail" />
						</a></li>
						<li><a href="#" onclick="ShowProfitLossByJob();"> <spring:message
									code="BzComposer.reportcenter.profitorloss.profitlossbyjob" />
						</a></li>
						<li><a href="#" onclick="showProfitLossByItem();"> <spring:message
									code="BzComposer.reportcenter.profitorloss.profitlossbyitem" />
						</a></li>
						<li><a href="#" onclick="showBudgetOverview();"> <spring:message
									code="BzComposer.reportcenter.profitorloss.profitlossbudgetoverview" />
						</a></li>
						<li><a href="#" onclick="showBudgetVsActual();"> <spring:message
									code="BzComposer.reportcenter.profitorloss.profitlossbudgetactual" />
						</a></li>
						<li><a href="#" onclick="showIncomeStatement();"> <spring:message
									code="BzComposer.reportcenter.financialreport.incomestatement" />
						</a></li>
						<li><a href="#" onclick="ShowBalSheet();"> <spring:message
									code="BzComposer.reportcenter.financialreport.balancesheet" />
						</a></li>
						<li><a href="#" onclick="ShowCashFlowForeCast();"> <spring:message
									code="BzComposer.reportcenter.cashflow.cashflowforecast" />
						</a></li>
						<li><a href="#" onclick="IncomeExpenseGraph();"> <spring:message
									code="BzComposer.reportcenter.graph.incomeandexpensegraph" />
						</a></li>
						<li><a href="#" onclick="Networth();"> <spring:message
									code="BzComposer.reportcenter.graph.networthgraph" />
						</a></li>
						<li><a href="#" onclick="BudgetvsActualGraph();"> <spring:message
									code="BzComposer.reportcenter.graph.budgetvsactualgraph" />
						</a></li>
					</ul></li>
				<li><a href="javascript: void(0)"> <span><spring:message
								code="BzComposer.reportcenter.tax" /></span>
				</a>
					<ul>
						<li><a href="#" onclick="ShowSalesTaxSummary();"> <spring:message
									code="BzComposer.reportcenter.tax.salestax.summary" />
						</a></li>
						<li><a href="#" onclick="ShowReportTaxDetail();"> <spring:message
									code="BzComposer.reportcenter.tax.salestax.detail" />
						</a></li>
					</ul></li>
				<li><a href="javascript: void(0)"> <span><spring:message
								code="BzComposer.reportcenter.lists" /></span>
				</a>
					<ul>
						<li><a href="#" onclick="ChartsofCategories();"> <spring:message
									code="BzComposer.reportcenter.lists.chartsofcategories" />
						</a></li>
						<li><a href="#" onclick="TermList();"> <spring:message
									code="BzComposer.reportcenter.lists.termlist" />
						</a></li>
						<li><a href="#" onclick="SaleRepList();"> <spring:message
									code="BzComposer.reportcenter.lists.salereplist" />
						</a></li>
						<li><a href="#" onclick="PaymentMethodList();"> <spring:message
									code="BzComposer.reportcenter.lists.paymentmethodlist" />
						</a></li>
						<li><a href="#" onclick="ShipViaList();"> <spring:message
									code="BzComposer.reportcenter.lists.shipvialist" />
						</a></li>
						<li><a href="#" onclick="TaxTypeList();"> <spring:message
									code="BzComposer.reportcenter.lists.taxtypelist" />
						</a></li>
						<li><a href="#" onclick="FootnoteList();"> <spring:message
									code="BzComposer.reportcenter.lists.footnotelist" />
						</a></li>
						<li><a href="#" onclick="MessageList();"> <spring:message
									code="BzComposer.reportcenter.lists.messagelist" />
						</a></li>
					</ul></li>
				<li><a href="javascript: void(0)"> <span><spring:message
								code="BzComposer.reportcenter.esales" /></span>
				</a>
					<ul>
						<li><a href="#" onclick="ESales_Invoice_Detail();"> <spring:message
									code="BzComposer.reportcenter.esalesinvoicedetail" />
						</a></li>
						<li><a href="#" onclick="ESales_Refund_Detail();"> <spring:message
									code="BzComposer.reportcenter.esalesrefunddetail" />
						</a></li>
						<li><a href="#" onclick="ESales_sale_Detail();"> <spring:message
									code="BzComposer.reportcenter.esalessaledetail" />
						</a></li>
						<li><a href="#" onclick="ESales_Inventory_Sale_Statistics();">
								<spring:message
									code="BzComposer.reportcenter.esalesinventorysalestatistics" />
						</a></li>
						<li><a href="#" onclick="Cross_Sell_Inventory_Report();">
								<spring:message
									code="BzComposer.reportcenter.crosssale.crosssaledetail" />
						</a></li>
						<li><a href="#" onclick="ESale_Sales_Graph();"> <spring:message
		...
		<li><a href="Configuration?tabid=config" title="Confuguration"
			class="uppercaseText"> <spring:message
...
<div id="ex1" class="modal modal1">
	...
	<br> <a href="#" rel="modal:close"><spring:message
			code="BzComposer.global.close" /></a>
	</center>
</div>
<script type="text/javascript">
	function ShowCustomerList()
