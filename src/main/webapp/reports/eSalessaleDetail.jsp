...
<title>${sessionScope.user} - <bean:message key="ReportCenter.eSales_sale_Detail"/></title>
</head>
<body>

<html:form action="ReportCenterESales.do?tabid=ESalessaleDetail" method="post">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="ReportCenter.eSales_sale_Detail"/></h6>
	</div>
	<div id="table-negotiations"
		...
		<thead>
			<tr>
					<th><bean:message key="eSalesSalesReportDetails.Client/Vendor" /></th>
					<th><bean:message key="eSalesSalesReportDetails.Invoice_No." /></th>
					<th><bean:message key="eSalesSalesReportDetails.Date" /></th>
					<th><bean:message key="eSalesSalesReportDetails.Item_Name" /></th>
					<th><bean:message key="eSalesSalesReportDetails.Quantity" /></th>
...
function search()
{
	document.forms[0].action = "ReportCenterESales.do?tabid=ESalessaleDetail";
