...
<title>${sessionScope.user} - <bean:message key="BzComposer.DailySales.Summary"/></title>
</head>
<body>

<html:form action="Item.do?tabid=showDailySalesSummary" method="post">
	...
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.DailySales.Summary"/></h6>
	</div>
...
function search()
{
	document.forms[0].action = "Item.do?tabid=showDailySalesSummary";
