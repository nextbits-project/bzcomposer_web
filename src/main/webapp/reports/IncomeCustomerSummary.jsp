...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.Customer.Income.IncomeByCustomerSummary"/></title>
</head>
<body>

<html:form action="Customer.do?tabid=IncomeCustomerSummary" method="post">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.Customer.Income.IncomeByCustomerSummary"/></h6>
	</div>
	<div id="table-negotiations"
		...
		<tbody>
				<logic:present name="incomeCustomerSummary" scope="request">
				<logic:notEmpty name="incomeCustomerSummary" scope="request">
<%-- 					<input type="hidden" name="sListSize" id="lSize"
						value='<bean:write name="catList" />'>
 --%>				<logic:iterate name="incomeCustomerSummary" id="objList" indexId="ndx">
						<tr>
...
function search()
{
	document.forms[0].action = "Customer.do?tabid=IncomeCustomerSummary";
