...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.CustomerBalanceDetail"/></title>
</head>
<body>

<html:form action="Customer.do?tabid=CustomerBalDetail" method="post">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.CustomerBalanceDetail"/></h6>
	</div>
	<div id="table-negotiations"
		...
		<thead>
			<tr>
					<th><bean:message
								key="BzComposer.Companyinformation.Customer" /></th>
			<th><bean:message key="BzComposer.Invoice.Date" /></th> 
			<th><bean:message key="BzComposer.Invoice.OrderNo" /></th> 
			<th><bean:message key="BzComposer.Invoice.Amt" /></th> 
			<th><bean:message key="BzComposer.Report.Purchaseorder.Balance" /></th> 
			</tr>
		</thead>

		<tbody>
				<logic:present name="balanceDetail" scope="request">
				<logic:notEmpty name="balanceDetail" scope="request">
<%-- 					<input type="hidden" name="sListSize" id="lSize"
						value='<bean:write name="catList" />'>
 --%>				<logic:iterate name="balanceDetail" id="objList" indexId="ndx">
						<tr>
...
function search()
{
	document.forms[0].action = "Customer.do?tabid=CustomerBalDetail";
