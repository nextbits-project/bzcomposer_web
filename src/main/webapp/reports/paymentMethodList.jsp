...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.Lists.PaymentMethod"/></title>
</head>
<body>

<html:form action="ReportCenterLists.do?tabid=ChartsofCategories" method="post">
...
<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.Lists.PaymentMethod"/></h6>
	</div>
	...
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<table class="tabla-customListOds" cellspacing="0" id="exportPd" border="1">
			...
			<thead>
				<tr>
						<th><bean:message key="PaymentTypeList.Payment_Type" /></th>
						<th><bean:message key="PaymentTypeList.Name" /></th>
				</tr>
			</thead>
			...
			<tbody>
				...
				<tr>
							<td><bean:write name="objList" property="paymentType" /></td>
							<td><bean:write name="objList" property="paymentName" /></td>
				</tr>
				</logic:iterate>
				...
				<logic:iterate name="acList" id="objList" indexId="ndx">
						<tr>
							<td><bean:write name="objList" property="categoryTypeName" /></td>
							<td><bean:write name="objList" property="categoryName" /></td>
							<td><bean:write name="objList" property="cateNumber" /></td>
							<td><bean:write name="objList" property="catedescription" /></td>
							<td><bean:write name="objList" property="budgetCateName" /></td>
						</tr>
					</logic:iterate>
				</logic:notEmpty>
			</logic:present> --%>
