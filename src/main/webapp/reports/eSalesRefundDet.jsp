...
<title>${sessionScope.user} - <bean:message key="ReportCenter.eSales_Refund_Detail"/></title>
</head>
<body>

<html:form action="ReportCenterESales.do?tabid=ESalesRefundDetail" method="post">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="ReportCenter.eSales_Refund_Detail"/></h6>
	</div>
	<div id="table-negotiations"
		...
		<thead>
			<tr>
					<th><bean:message key="eSalesRefundReportDetails.Client/Vendor" /></th>
					<th><bean:message key="eSalesRefundReportDetails.Order_No." /></th>
					<th><bean:message key="eSalesRefundReportDetails.Date" /></th>
					<th><bean:message key="eSalesRefundReportDetails.Item_Name" /></th>
					<th><bean:message key="eSalesRefundReportDetails.Quantity" /></th>
...
function search()
{
	document.forms[0].action = "ReportCenterESales.do?tabid=ESalesRefundDetail";
