...
<title>${sessionScope.user} - <bean:message key="ReportCenter.eSales_Inventory_Sale_Statistics"/></title>
</head>
<body>

<html:form action="ReportCenterESales.do?tabid=ESalesInventorySaleStatistics" method="post">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="ReportCenter.eSales_Inventory_Sale_Statistics"/></h6>
	</div>
	<div id="table-negotiations"
		...
		<thead>
			<tr>
					<th><bean:message key="eSalesInvoiceDetails.Store_Type" /></th>
					<th><bean:message key="eSalesInvoiceDetails.Store_Name" /></th>
					<th><bean:message key="eSalesInvoiceDetails.Inventory_Name" /></th>
					<th><bean:message key="eSalesInvoiceDetails.Date" /></th>
					<th><bean:message key="eSalesInvoiceDetails.Qty" /></th>
...
function search()
{
	document.forms[0].action = "ReportCenterESales.do?tabid=ESalesInventorySaleStatistics";
