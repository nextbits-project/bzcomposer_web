...
<title>${sessionScope.user}-<bean:message key="BzComposer.vendorbalancedetailtitle"/></title>
</head>
<body>
<html:form action="PurchaseBoard.do?tabid=VendorBalancedetails" method="post">
	...
	<div id="printContent">
		<div id="headerBar">
			...
			<h6 style="text-align: center; color: blue;" id="headerBarValue">
				<bean:message key="BzComposer.report.vendorbalancelist.vendorbalancedetailstitle" />
			</h6>
		</div>								
		...
		<div id="table-negotiations" style="overflow: auto; height: 400; text-align: center;">
			<table class="tabla-customListOds" id="exportPd" border="1">
				<thead>
					<tr>
						<th><bean:message key="BzComposer.report.vendorbalancelist.name" /></th>	
						<th><bean:message key="BzComposer.report.vendorbalancelist.podate" /></th>
						<th><bean:message key="BzComposer.report.vendorbalancelist.ponumber" /></th>	
					<%--<th><bean:message key="BzComposer.Report.vendor.BalanceSummary.Type" /></th>
						...
						<th><bean:message key="BzComposer.report.vendorbalancelist.amount" /></th>
					<%--<th><bean:message key="BzComposer.Report.vendor.BalanceSummary.PaidAmount" /></th>--%>
					...
					<logic:present name="PurchaseBoardDetails" scope="request">
						<logic:notEmpty name="PurchaseBoardDetails" scope="request">
							...
							<logic:iterate name="PurchaseBoardDetails" id="objList" indexId="ndx">
								<tr>
									<td>
										<bean:write name="objList" property="firstName" />(<bean:write name="objList"
...
function search()
{
	document.forms[0].action = "PurchaseBoard.do?tabid=VendorBalancedetails";
