...
<title>${sessionScope.user} - <bean:message key="BzComposer.invoicelisttitle"/></title>
</head>
<body>
<html:form action="SalesBord.do?tabid=AllInvoiceList&ilist=1" method="post">
...
function search()
{
	document.forms[0].action = "SalesBord.do?tabid=AllInvoiceList&ilist=1";
