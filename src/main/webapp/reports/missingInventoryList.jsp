...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.Missing.InventoryList"/></title>
</head>
<body>

<html:form action="Item.do?tabid=MissingInventoryList" method="post">
	...
	<span
		...
		<bean:message key="BzComposer.Report.Missing.InventoryList" />
	...
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.Missing.InventoryList"/></h6>
	</div>
	...
	<table class="tabla-listados" cellspacing="0">
		...
		<thead>
			<tr>
				<th><bean:message key="BzComposer.Report.Missing.InventoryList.InventoryName" /></th>
				<th><bean:message key="BzComposer.Report.Missing.InventoryList.Description" /></th>
				<th><bean:message key="BzComposer.Report.Missing.InventoryList.AdjustedQty" /></th>
				<th><bean:message key="BzComposer.Report.Missing.InventoryList.Date" /></th>
				<th><bean:message key="BzComposer.Report.Missing.InventoryList.Reason" /></th>
				<th><bean:message key="BzComposer.Report.Missing.InventoryList.Ref.CustomerRMA" /></th>
			</tr>
		</thead>
		<tbody>
					...
					<logic:iterate name="missingInventoryList" id="objList" indexId="ndx">
						<tr >
							<td align="left"><bean:write name="objList"
						     ...
						     <td align="left"><bean:write name="objList"
								property="inventoryDescription" /></td>
							<td align="left"><bean:write name="objList"
								property="Adjustqty" />
							</td>	
...
function callRefresh(){
	document.forms[0].action = "Item.do?tabid=MissingInventoryList";
