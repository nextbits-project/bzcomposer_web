...
<title>${sessionScope.user} - <bean:message key="BzComposer.SalesPanel.SalesReportByItem"/></title>
</head>
<body>

<html:form action="SalesBord.do?tabid=SalesRBI&ilist=2" method="post">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.SalesPanel.SalesReportByItem"/></h6>
	</div>
	<div id="table-negotiations"
		...
		<thead>
			<tr>
				...
				<th><bean:message key="BzComposer.Report.ReservedInventoryList.SoldQty" /></th>
				<th><bean:message key="BzComposer.Report.ReservedInventoryList.SoldAmt" /></th>
				<th><bean:message key="BzComposer.Report.Employee.SalesReportByRep.RefundQty" /></th>
				<th><bean:message key="BzComposer.Report.Employee.SalesReportByRep.RefundAmount" /></th>
			</tr>
		</thead>
...
<%-- 					<input type="hidden" name="sListSize" id="lSize"
 ...
 --%>				<logic:iterate name="salesRBC" id="objList" indexId="ndx">
						...
						<td><bean:write name="objList"
							...
							<td><bean:write name="objList"
								property="refundQty" /></td>							
						    <td><bean:write name="objList"
								property="refundAmt" /></td>
						</tr>
					</logic:iterate>
				</logic:notEmpty>
			</logic:present>
...
function search()
{
	document.forms[0].action = "SalesBord.do?tabid=SalesRBI&ilist=2";
