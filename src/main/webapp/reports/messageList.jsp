...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.Lists.Message"/></title>
</head>
<body>
...
<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.Lists.Message"/></h6>
	</div>
	...
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<table class="tabla-customListOds" cellspacing="0" id="exportPd" border="1">
			...
			<thead>
				<tr>
						<th><bean:message key="MessageList.Message" /></th>
				</tr>
			</thead>
			...
			<tbody>
				...
				<tr>
							<td><bean:write name="objList" property="message" /></td>
				</tr>
				</logic:iterate>
