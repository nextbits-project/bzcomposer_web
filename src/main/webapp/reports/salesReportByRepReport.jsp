...
<title><bean:message key="BzComposer.salesreportbyrepdetailstitle"/></title>
</head>
<body>
<html:form action="SalesBord.do?tabid=SalesReportByRep" method="post">
<div id="">
...
<div>
	...
	border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
		<bean:message key="BzComposer.report.salesreportbyrep.salesreportbyreptitle" />
	</span>
</div>
<div>
					...
					<table class="table-notifications" width="100%">
						<tr>
							<th colspan="5" align="left">
								<bean:message key="BzComposer.report.salesreportbyrep.filteroption" />
							</th>
						</tr>
						<tr>
							<td width="30%">
		...
		<div>
			...
			<div id="table-negotiations" style="overflow:auto;height:400;width:100%" class="section-border">
				<table class="tabla-listados" cellspacing="0">
					<thead>
						<tr>
							<th><bean:message key="BzComposer.report.salesreportbyrep.salesrepresentative" /></th>
							<th><bean:message key="BzComposer.report.salesreportbyrep.salesquantity" /></th>
							<th><bean:message key="BzComposer.report.salesreportbyrep.salesamount" /></th>
							<th><bean:message key="BzComposer.report.salesreportbyrep.refundamount" /></th>
							<th><bean:message key="BzComposer.report.salesreportbyrep.refundquantity" /></th>
							<th><bean:message key="BzComposer.report.salesreportbyrep.adjustedsales" /></th>
						</tr>
					</thead>
					<tbody>
						<logic:present name="SalesReportByRep" scope="request">
							<logic:notEmpty name="SalesReportByRep" scope="request">
								<bean:size id="SalesListSize" name="SalesReportByRep" />
								<input type="hidden" name="sListSize" id="lSize" 
								value='<bean:write name="SalesListSize" />'>
								<logic:iterate name="SalesReportByRep" id="objList" indexId="ndx"  >
									<tr>
										<td align="left"><bean:write name="objList" property="rep" /></td>	
										<td align="left"><bean:write name="objList" property="inventoryQty" /></td>
										<td align="left"><bean:write name="objList" property="total" /></td>
										<td align="left">0</td>	
										<td align="left">.00</td>
										<td align="left"><bean:write name="objList" property="total" /></td>
									</tr>
