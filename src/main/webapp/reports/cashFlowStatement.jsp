...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.Profit&Budget.CashFlowStatement"/></title>
</head>
<body>

<html:form action="ShowCashFlow.do?tabid=BalanceSheet" method="post">
...
<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.Profit&Budget.CashFlowStatement"/></h6>
	</div>
	...
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<table class="tabla-customListOds" cellspacing="0" id="exportPd" border="1">
			...
			<thead>
				<tr>
						<th><bean:message key="CashFlowStatement.Activity" /></th>
						<th><bean:message key="CashFlowStatement.Amount" /></th>
				</tr>
			</thead>
			...
			<tbody>
				...
				<tr>
					<td><bean:message key="CashFlowStatement.OPERATING_ACTIVITIES"/></td>
					<td>&nbsp;</td>
				</tr>
				
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="CashFlowStatement.Net_Income"/></td>
					<td><bean:write name="CashFlowStatement.NetIncome"/></td>
				</tr>
				
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="CashFlowStatement.Adjust_To_Reconcile_Net_Income"/></td>
					<td></td>
				</tr>
				
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="CashFlowStatement.To_Net_Provided_By_Operations"/></td>
					<td></td>
				</tr>
				
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="CashFlowStatement.Accounts_Receivable"/></td>
					<td><bean:write name="CashFlowStatement.ARBalance"/></td>
				</tr>
				
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="CashFlowStatement.Accounts_Payable"/></td>
					<td><bean:write name="CashFlowStatement.APBalance"/></td>
				</tr>
				
				<tr>
					<td><bean:message key="CashFlowStatement.Net_Cash_Provided_By_Operating_Activities"/></td>
					<td><bean:write name="CashFlowStatement.NetCashProvidedByOA"/></td>
				</tr>
				...
				<tr>
					<td><bean:message key="CashFlowStatement.FINANCING_ACTIVITIES"/></td>
					<td></td>
				</tr>
				
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="CashFlowStatement.Opening_Balance_Equity"/></td>
					<td><bean:write name="CashFlowStatement.OBE"/></td>
				</tr>
				
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="CashFlowStatement.Net_Cash_Provided_By_Financing_Activities"/></td>
					<td><bean:write name="CashFlowStatement.NetCashProvidedByFA"/></td>
				</tr>
				
				<tr>
					<td><bean:message key="CashFlowStatement.Net_Cash_Increased_By_Period"/></td>
					<td><bean:write name="CashFlowStatement.NetCashIncreasedByPeriod"/></td>
				</tr>
				
				<tr>
					<td><bean:message key="CashFlowStatement.Cash_At_The_End_Of_Period"/></td>
					<td><bean:write name="CashFlowStatement.CashAtTheEndOfPeriod"/></td>
				</tr>
