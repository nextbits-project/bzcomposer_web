...
<title>${sessionScope.user} - <bean:message key="ReportCenter.eSales_Invoice_Detail"/></title>
</head>
<body>

<html:form action="ReportCenterESales.do?tabid=ESales_Invoice_Detail" method="post">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="ReportCenter.eSales_Invoice_Detail"/></h6>
	</div>
	<div id="table-negotiations"
		...
		<thead>
			<tr>
					<th><bean:message key="eSalesInvoiceDetails.Order_No." /></th>
					<th><bean:message key="eSalesInvoiceDetails.Date" /></th>
					<th><bean:message key="eSalesInvoiceDetails.Client/Vendor" /></th>
					<th><bean:message key="eSalesInvoiceDetails.Amount" /></th>
					<th><bean:message key="eSalesInvoiceDetails.Balance" /></th>
...
function search()
{
	document.forms[0].action = "ReportCenterESales.do?tabid=ESales_Invoice_Detail";
