...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.Lists.Footnote"/></title>
</head>
<body>
...
<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.Lists.Footnote"/></h6>
	</div>
	...
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<table class="tabla-customListOds" cellspacing="0" id="exportPd" border="1">
			...
			<thead>
				<tr>
						<th><bean:message key="FootNoteList.Footnote_Name" /></th>
						<th><bean:message key="FootNoteList.Description" /></th>
				</tr>
			</thead>
			...
			<tbody>
				...
				<tr>
							<td><bean:write name="objList" property="footnoteName" /></td>
							<td><bean:write name="objList" property="description" /></td>
				</tr>
				</logic:iterate>
