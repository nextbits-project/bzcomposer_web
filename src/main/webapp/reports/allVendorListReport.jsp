...
<title>${sessionScope.user}-<bean:message key="BzComposer.allvendorlisttitle"/></title>
</head>
<body>
<html:form action="PurchaseBoard.do?tabid=AllVendorList" method="post">
		...
		<div id="printContent">
			<div id="headerBar">
				...
				<h6 style="text-align: center; color: blue;" id="headerBarValue">
					<bean:message key="BzComposer.report.vendorpurchaselist.vendorlist" />
				</h6>
			</div>
			<div id="table-negotiations" style="overflow: auto; height: 400; text-align: center;">
				<table class="tabla-customListOds" id="exportPd" border="1">
					<thead>
						<tr>
							<th><bean:message key="BzComposer.report.vendorpurchaselist.companyname" /></th>
							<th><bean:message key="BzComposer.global.firstname" /></th> 
							<th><bean:message key="BzComposer.global.lastname" /></th> 	
							<th><bean:message key="BzComposer.global.phone" /></th>		
							<th><bean:message key="BzComposer.global.fax" /></th>
							<th><bean:message key="BzComposer.global.email" /></th>
							<th><bean:message key="BzComposer.global.address1" /></th>															
							<th><bean:message key="BzComposer.global.address2" /></th>
							<th><bean:message key="BzComposer.global.city" /></th>
							<th><bean:message key="BzComposer.global.state" /></th>
							<th><bean:message key="BzComposer.global.province" /></th>
							<th><bean:message key="BzComposer.global.country" /></th>
							<th><bean:message key="BzComposer.global.zipcode" /></th>
							<th><bean:message key="BzComposer.report.vendorpurchaselist.detail"/></th>				
						</tr>
					</thead>
					<tbody>
								...
								<logic:iterate name="VendorDetails" id="objList" indexId="ndx">
									<tr>
										<td><bean:write name="objList" property="cname" /></td>
									  	...
									  	<td><bean:write name="objList" property="address1" /></td>
									  	<td><bean:write name="objList" property="address2" /></td>
									  	<td><bean:write name="objList" property="city" /></td>
									  	<td><bean:write name="objList" property="stateName" /></td>
									  	<td><bean:write name="objList" property="province" /></td>
									  	<td><bean:write name="objList" property="country" /></td>
									  	<td><bean:write name="objList" property="zipCode" /></td>
									  	<td><bean:write name="objList" property="memo" /></td>				
									</tr>
								</logic:iterate>
							</logic:notEmpty>
						</logic:present>
...
function search()
{
	document.forms[0].action = "PurchaseBoard.do?tabid=AllVendorList";
