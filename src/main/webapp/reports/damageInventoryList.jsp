...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.Damage.InventoryList"/></title>
</head>
<body>

<html:form action="Item.do?tabid=showDamageInventoryList" method="post">
	...
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.Damage.InventoryList"/></h6>
	</div>
