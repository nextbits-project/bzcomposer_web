...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.Returned.InventoryList"/></title>
</head>
<body>

<html:form action="Item.do?tabid=showReturnedInventoryList" method="post">
	...
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.Returned.InventoryList"/></h6>
	</div>
...
<table class="tabla-customListOds" id="exportPd" border="1">
		...
		<thead>
			<tr>
				<th><bean:message key="BzComposer.Report.InventoryId" /></th>
				<th><bean:message key="BzComposer.Report.ReservedInventoryList.InventoryCode" /></th>
				<th><bean:message key="BzComposer.Report.ReservedInventoryList.OldQty" /></th>
				<th><bean:message key="BzComposer.Report.ReservedInventoryList.NewQty" /></th>
				<th><bean:message key="BzComposer.Report.ItemInventory.Gap" /></th>
				<th><bean:message key="BzComposer.Employee.Memo" /></th>
			</tr>
		</thead>
		<tbody>
			<%-- <logic:present name="damagesItemList" scope="request">
				<logic:notEmpty name="damagesItemList" scope="request">
					...
					<logic:iterate name="damagesItemList" id="objList" indexId="ndx">
						<tr >
							<td align="left"><bean:write name="objList"
								property="inventoryId" /></td>
						     <td align="left"><bean:write name="objList"
								property="inventoryCode" /></td>
							<td align="left"><bean:write name="objList"
								property="oldQty" />
							</td>	
...
function search()
{
	document.forms[0].action = "Item.do?tabid=showReturnedInventoryList";
