...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.Sales.SalesByCustomerSummary"/></title>
</head>
<body>

<html:form action="Customer.do?tabid=SalesByCustomerSummary" method="post">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.Sales.SalesByCustomerSummary"/></h6>
	</div>
	<div id="table-negotiations"
		...
		<tbody>
				<logic:present name="getSalesCustomerSummary" scope="request">
				<logic:notEmpty name="getSalesCustomerSummary" scope="request">
<%-- 					<input type="hidden" name="sListSize" id="lSize"
						value='<bean:write name="catList" />'>
 --%>				<logic:iterate name="getSalesCustomerSummary" id="objList" indexId="ndx">
						<tr>
...
function search()
{
	document.forms[0].action = "Customer.do?tabid=SalesByCustomerSummary";
