...
<title>${sessionScope.user} - <bean:message key="BzComposer.customerlisttitle"/></title>
</head>
<body>
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.reportcenter.listing.customerlist"/></h6>
	</div>
		...
		<thead>
			<tr>
					<th><bean:message
							...
							<th><bean:message key="BzComposer.reportcenter.tax.salestax.detail"/></th>		
			</tr>
		</thead>
...
<%-- 					<input type="hidden" name="sListSize" id="lSize"
 ...
 --%>				<logic:iterate name="customerlist" id="objList" indexId="ndx">
						<tr>
