...
<html:form action="ReportCenterESales.do?tabid=CrossSellInventoryReport" method="post">
	    	...
	    	<tr>
	    		...
	    		<td>
	    		  <html:select property="datesCombo">
	    		  	<html:option value="0" ><bean:message key="BzComposer.reportcenter.allinvoicelist.dates.all"/></html:option>
	    		  	<html:option value="1"><bean:message key="BzComposer.reportcenter.allinvoicelist.dates.today"/></html:option>
	    		  	<html:option value="2"><bean:message key="BzComposer.reportcenter.allinvoicelist.dates.thisweek"/></html:option>
	    		  	<html:option value="3"><bean:message key="BzComposer.reportcenter.allinvoicelist.dates.thisweektodate"/></html:option>
	    		  	<html:option value="4"><bean:message key="BzComposer.reportcenter.allinvoicelist.dates.thismonth"/></html:option>
	    		  	<html:option value="5"><bean:message key="BzComposer.reportcenter.allinvoicelist.dates.thismonthtodate"/></html:option>
	    		  	<html:option value="6"><bean:message key="BzComposer.reportcenter.allinvoicelist.dates.fiscalquarter"/></html:option>
	    		  	<html:option value="7"><bean:message key="BzComposer.reportcenter.allinvoicelist.dates.fiscalquartertodate"/></html:option>
	    		  	<html:option value="8">
...
<div id="printContent">	
	...
	<div id="table-negotiations"
		...
		<tbody>
				...
				<tr>
							<td><bean:write name="objList" property="inventoryCode" /></td>
							<td><bean:write name="objList" property="sku" /></td>
							<td><bean:write name="objList" property="qtyOnHand" /></td>
							<td><bean:write name="objList" property="purchasePrice" /></td>
							<td><bean:write name="objList" property="salePrice" /></td>
				</tr>
				</logic:iterate>
...
function search()
{
	document.forms[0].action = "ReportCenterESales.do?tabid=CrossSellInventoryReport";
