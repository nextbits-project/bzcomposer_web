...
<title>${sessionScope.user} - <bean:message key="BzComposer.DailyItem.Summary"/></title>
</head>
<body>
...
<html:form action="Item.do?tabid=showReturnedInventoryList" method="post">
	...
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.DailyItem.Summary"/></h6>
	</div>
