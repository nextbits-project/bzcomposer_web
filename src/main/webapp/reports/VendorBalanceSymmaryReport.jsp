...
<title>${sessionScope.user}-<bean:message key="BzComposer.Report.vendor.BalanceSummary"/></title>
</head>
<body>

<html:form action="PurchaseBoard.do?tabid=VendorBalancesymmary" method="post">
...
<div id="printContent">	
	...
	<div id="headerBar">
											...
											<h6 style="text-align: center; color: blue;"
												id="headerBarValue">
												<bean:message key="BzComposer.Report.vendor.BalanceSummary" />
											</h6>
										</div>
				...
				<logic:notEmpty name="PurchaseBoardDetails" scope="request">
					...
					<logic:iterate name="PurchaseBoardDetails" id="objList" indexId="ndx">
						<tr>
							...
							<td ><bean:write name="objList" property="totalBalance" /></td>
						  	
						</tr>
					</logic:iterate>
					<tr>
					<td><b>Total</b></td>
					<td><B>	<bean:write name="total" /></B></td>
					</tr>
				</logic:notEmpty>
...
function search()
{
	document.forms[0].action = "PurchaseBoard.do?tabid=VendorBalancesymmary";
