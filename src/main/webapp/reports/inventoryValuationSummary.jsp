...
<title>${sessionScope.user} - <bean:message key="BzComposer.Valuation.InventoryValuation.Summary"/></title>
</head>
<body>

<html:form action="Item.do?tabid=InventoryValSummary" method="post">
	...
	<div id="ddcolortabsline">&nbsp;</div>
		...
		<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Valuation.InventoryValuation.Summary"/></h6>
	</div>
	...
	<table class="tabla-customListOds" id="exportPd" border="1">
		...
		<thead>
			<tr>
				...
				<th><bean:message key="BzComposer.Item.Inventory" /></th>
				<th><bean:message key="BzComposer.Report.InventoryOnHandQty" /></th>
				<th><bean:message key="BzComposer.Item.InventoryRetail" /></th>
			</tr>
		</thead>
		<tbody>
			<logic:present name="invValSummaryList" scope="request">
				<logic:notEmpty name="invValSummaryList" scope="request">

					<bean:size id="SalesListSize" name="invValSummaryList" />
...
function search()
{
	document.forms[0].action = "Item.do?tabid=InventoryValSummary";
