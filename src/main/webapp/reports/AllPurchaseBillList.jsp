...
<title>${sessionScope.user}-<bean:message key="BzComposer.Report.PurchaseBills"/></title>
</head>
<body>

<html:form action="PurchaseBoard.do?tabid=AllPurchaseBillList" method="post">
...
<div id="printContent">	
	...
	<div id="headerBar">
											...
											<h6 style="text-align: center; color: blue;"
												id="headerBarValue">
												<bean:message key="BzComposer.Report.PurchaseBills" />
											</h6>
										</div>
	...
	<table class="tabla-customListOds" id="exportPd" border="1">
		...
		<thead>
			<tr>
					<th ><bean:message key="BzComposer.accounting.Date" /></th>
					<th><bean:message key="BzComposer.Report.AllInvoice.ClientVendor" /></th>
...
function search()
{
	document.forms[0].action = "PurchaseBoard.do?tabid=AllPurchaseBillList";
