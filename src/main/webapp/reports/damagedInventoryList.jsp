...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.Damaged.InventoryList"/></title>
</head>
<body>

<html:form action="Item.do?tabid=showDamagedInventoryList" method="post">
	...
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.Damaged.InventoryList"/></h6>
	</div>
...
function search()
{
	document.forms[0].action = "Item.do?tabid=showDamageInventoryList";
