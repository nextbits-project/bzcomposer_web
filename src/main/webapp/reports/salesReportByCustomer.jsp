...
<title>${sessionScope.user} - <bean:message key="BzComposer.SalesPanel.SalesReportByCustomer"/></title>
</head>
<body>

<html:form action="SalesBord.do?tabid=SalesRBC&ilist=1" method="post">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.SalesPanel.SalesReportByCustomer"/></h6>
	</div>
	<div id="table-negotiations"
		...
		<thead>
			<tr>
					<th><bean:message key="BzComposer.Customer.Company" /></th>
				<th><bean:message key="BzComposer.Employee.Name" /></th>
				<th><bean:message key="BzComposer.SalesPanel.SalesTitle" /></th>
				<th><bean:message key="BzComposer.Report.Employee.SalesReportByRep.RefundAmount" /></th>
				<th><bean:message key="BzComposer.SalesPanel.AdjSales" /></th>
			</tr>
		</thead>
...
<%-- 					<input type="hidden" name="sListSize" id="lSize"
 ...
 --%>				<logic:iterate name="salesRBC" id="objList" indexId="ndx">
						...
						<td><bean:write name="objList"
							...
							<td><bean:write name="objList"
								property="refTotal" /></td>							
						    <td><bean:write name="objList"
								property="adjTotal" /></td>
						</tr>
					</logic:iterate>
				</logic:notEmpty>
			</logic:present>
...
function search()
{
	document.forms[0].action = "SalesBord.do?tabid=SalesRBC&ilist=1";
