...
<title>${sessionScope.user}-<bean:message key="BzComposer.Report.Vendor1099TransactionDetail"/></title>
</head>
<body>

<html:form action="PurchaseBoard.do?tabid=vendor1099TransactionDetail" method="post">
...
<div id="headerBar">
											...
											<h6 style="text-align: center; color: blue;"
												id="headerBarValue">
												<bean:message key="BzComposer.Report.Vendor1099TransactionDetail" />
											</h6>
										</div>
...
function search()
{
	document.forms[0].action = "PurchaseBoard.do?tabid=vendor1099TransactionDetail";
