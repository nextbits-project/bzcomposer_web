...
<title>${sessionScope.user} - <bean:message key="BzComposer.Report.AllEstimation"/></title>
</head>
<body>

<html:form action="EstimationBoard.do?tabid=AllEstimationList" method="post">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><bean:message key="BzComposer.Report.AllEstimation"/></h6>
	</div>
	<div id="table-negotiations"
		...
		<thead>
			<tr>
				<th><bean:message key="BzComposer.Estimaion.EstNum" /></th>
				<th><bean:message key="BzComposer.accounting.Date" /></th>
				<th><bean:message key="BzComposer.Report.AllInvoice.ClientVendor" /></th>
				<th><bean:message key="BzComposer.Invoice.Rep" /></th>
				<th><bean:message key="BzComposer.sales.SalesAmount" /></th>
...
function search()
{
	document.forms[0].action = "EstimationBoard.do?tabid=AllEstimationList";
