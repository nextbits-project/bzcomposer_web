...
<div id="table-negotiations" style="width: 185px;padding-left: 10px;overflow-y:auto;max-height: 900px;">
	<table class="tabla-listados" cellspacing="0">
		<tr onclick="SetRow1('tr1');" id="tr1">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config&&tab=tr1" id="tr1">
		...
		<tr onclick="SetRow1('tr2');" id="tr2">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config&&tab=tr2" id="tr2">
		...
		<tr onclick="SetRow1('tr3');" id="tr3">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config&&tab=tr3" id="tr3">
		...
		<tr onclick="SetRow1('tr4');" id="tr4">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config&&tab=tr4" id="tr4">
		...
		<tr onclick="SetRow1('tr5');" id="tr5">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config05&&tab=tr5" id="tr5">
		...
		<tr onclick="SetRow('tr6');" id="tr6">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config6&&tab=tr6" id="tr6">
...
var tab= <%= request.getParameter("tab") %>
	...
	function init1()
	{
		...
		//var value1 = document.configurationForm.selectedCountryId1.value;
		/* if(value1 == "2")
		{
		...
		{
			//SetRow('tr7');
			SetRow('tr5');			//commented on 01-05-2019
			setLogo();
			<logic:present name="EmpState">
			refreshItemsNow(document.configurationForm.empCountryID.value,'<bean:write name="EmpState"/>');
			</logic:present>
	...
	function SetRowColor(selTab)
	{
		...
		var rd=document.getElementById(selTab);
		rd.style.background = '#8798DE';
	}
