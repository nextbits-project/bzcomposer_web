...
<title><bean:message key="BzComposer.performancetitle" /></title>
...
/* commented on 24-11-2019 for preventing alert 
	...
	<table cellspacing="0"  style="width: 100%;overflow-y:scroll;" class="section-border">
		<tr>
			...
			<table class="table-notifications" width="100%">
				<tr>
					<th align="left" style="font-size: 1.2em;"><bean:message
						key="BzComposer.configuration.performancelevel" /></th>
				</tr>
				<tr>
					<td style="font-size: 1em;"><html:radio property="performance" value="2000">
						<bean:message key="BzComposer.configuration.performance.high" />
					</html:radio></td>
				</tr>
				<tr>
					<td style="font-size: 1em;"><html:radio property="performance" value="5000">
						<bean:message key="BzComposer.configuration.performance.medium" />
					</html:radio></td>
				</tr>
				<tr>
					<td style="font-size: 1em;"><html:radio property="performance" value="10000">
						<bean:message key="BzComposer.configuration.performance.low" />
					</html:radio></td>
				</tr>
				<tr>
					<td style="font-size: 1em;"><html:radio property="performance" value="1"
						onclick="CheckPerformance();">
						<bean:message
							key="BzComposer.configuration.performance.userdefine" />
					</html:radio><html:text size="15" property="userDefinePerform" maxlength="15"
						onkeypress="return numbersonly(event,this.value);" /></td>
				</tr>
				<tr>
					<td style="font-size: 1em;"><b><bean:message
						key="BzComposer.configuration.exitprogrammessage" /></b></td>
				</tr>
			</table>
			</div>
			<!-- Performance Ends -->			
...
function SaveValues()
{
	...
	{
		debugger
		document.configurationForm.performance.value = document.configurationForm.performance.value;
		
		document.getElementById('tabid').value="SavePerformance";
