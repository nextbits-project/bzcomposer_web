...
<title><bean:message key="BzComposer.paymentgatewaytitle" /></title>
	...
	<table cellspacing="0"  style="border: 0;width: 100%;overflow-y:scroll;" class="section-border">
		...
		<tr>
			...
			<div id="paymentGateway" style="display:none;padding: 0; position: relative; left: 0;">
				...
				<tr>
					<th colspan="2" align="left" style="font-size: 14px; padding: 5px;">
						<bean:message key="BzComposer.configuration.selectpaymentgateway" /></th>
					<th>&nbsp;&nbsp;</th>
				</tr>
				<tr>
					<td style="font-size: 14px;">
						<b><bean:message key="BzComposer.configuration.defaultpaymentgateways"/> :</b>
					</td>
					<td style="font-size: 14px;">
						<html:select property="selectedPaymentGatewayId" onchange="showPaymentGateway()">
							<logic:present name="configurationForm" property="listOfExistingPaymentGateways"> 
								<logic:iterate name="configurationForm" id="objList1" property="listOfExistingPaymentGateways" scope="session">
									<option value="<bean:write name='objList1' property='gateWayId' />"><bean:write name="objList1" property="gatewayName" /></option>
								</logic:iterate>
							</logic:present> 
						</html:select>
					</td>
				...
				<tr>
					<td style="font-size: 14px;">
						<b><bean:message key="BzComposer.configuration.defaultpaymentenvironment"/></b>
					</td>
					<td style="font-size: 14px;">
						<select id="paymentEnviromentId">
							<option value="0">
								<bean:message key="BzComposer.configuration.livepaymentprocessing"/>
							</option>
							<option value="1" selected>
								<bean:message key="BzComposer.configuration.sandboxpaymentprocessing"/>
							</option>
						</select>
					</td>
				</tr>
				...
				<div id="authorizeNet" style="display:none;">
					<div>			
						<table style="width:600px;height:300px;">
							<tr>
								<td align="center">
									<img id="img1" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/authorize.jpg' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
								<h1><b><bean:message key="BzComposer.configuration.authorizenet"/></b></h1>	  
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.authorizenetid"/>:</b>
								</td>
								<td align="center" style="font-size: 1em;">
									<select id="authorizeNetId" name="authorizeNetId" onclick="showAuthorizedID()" style="display:block;">
										<logic:present name="configurationForm" property="listOfExistingPaymentGateways"> 
											<logic:iterate name="configurationForm" id="objList1" property="listOfExistingPaymentGateways" scope="session">
												<option value="<bean:write name="objList1" property="gateWayId" />" hidden disabled><bean:write name="objList1" property="fieldName1" /></option>
											</logic:iterate>
										</logic:present>
									</select>
							...
							<tr>
							<td align="center" style="font-size: 14px;">
								<b><bean:message key="BzComposer.configuration.authorizenettranscationkey"/>:</b>
							</td>
							<td align="center" style="font-size: 14px;">
								<select id="authorizeNetTranscationKey" name="authorizeNetTranscationKey" onclick="showAuthorizedTransactionKey()" style="display:block;">
									<logic:present name="configurationForm" property="listOfExistingPaymentGateways"> 
										<logic:iterate name="configurationForm" id="objList1" property="listOfExistingPaymentGateways" scope="session">
											<option value="<bean:write name="objList1" property="gateWayId" />" hidden disabled><bean:write name="objList1" property="fieldName2" /></option>
										</logic:iterate>
									</logic:present>
								</select>
				...
				<div id="eProcessingNetwork" style="display:none;">
					<div>			
						<table style="width:600px;height:300px;">
							<tr>
								<td align="center">
									<img id="img2" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/eProcess.jpg' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
								<h1><b><bean:message key="BzComposer.configuration.eprocessingnetwork"/></b></h1>	  
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<bean:message key="BzComposer.configuration.eprocessingnetworkapiloginid"/> :
								</td>
								<td align="center" style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<bean:message key="BzComposer.configuration.apipassword"/> :
								</td>
								<td align="center" style="font-size: 14px;">
									<select id="apiPassword" name="apiPassword" onclick="showApiPassword()" style="display:block;">
									<logic:present name="configurationForm" property="listOfExistingPaymentGateways"> 
									<logic:iterate name="configurationForm" id="objList1" property="listOfExistingPaymentGateways" scope="session">
										<option value="<bean:write name="objList1" property="fieldName2" />"><bean:write name="objList1" property="fieldName2" /></option>
									</logic:iterate>
									</logic:present>
									</select>
				...
				<div id="paypal" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img3" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/PayPal_New.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.paypal"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.paypal.username"/> :</b>
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.paypal.password"/> :</b>
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.apisignature"/> :</b>
								</td>
								<td style="font-size: 14px;">
									 <select id="apiSignature" name="apiSignature" onclick="showpaypalApiSignature()" style="display:block;">
									<logic:present name="configurationForm" property="listOfExistingPaymentGateways"> 
									<logic:iterate name="configurationForm" id="objList1" property="listOfExistingPaymentGateways" scope="session">
										<option value="<bean:write name="objList1" property="gateWayId" />" hidden disabled><bean:write name="objList1" property="fieldName4" /></option>
									</logic:iterate>
									</logic:present>
									</select> 
				...
				<div id="cyberSource" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img4" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/CyberSource.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.cybersource"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<bean:message key="BzComposer.configuration.merchantid"/> :
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<bean:message key="BzComposer.configuration.certificatepath"/> :
								</td>
								<td style="font-size: 14px;">
									<html:file property="gatewayName"></html:file>
								</td>
							</tr>
						</table>
					</div>
				...
				<div id="eWay" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img5" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/Eway.GIF' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.eway"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<bean:message key="BzComposer.configuration.ewaymerchantid"/> :
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<bean:message key="BzComposer.configuration.ewayrefundpassword"/> :
								</td>
								<td style="font-size: 14px;">
									<html:password property="eWayRefundPassword"></html:password>
								</td>
							</tr>
						</table>
					</div>
				...
				<div id="fastCharge" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img6" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/FastCharge.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.fastcharge"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.fastchargemerchantid"/> :</b>
								</td>
								<td style="font-size: 14px;">
				...
				<div id="goEMerchant" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img8" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/goemerchant.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.goemerchant"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.loginid"/> :</b>
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.merchantpassword"/> :</b>
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.refundid"/> :</b>
								</td>
								<td style="font-size: 14px;">
				...
				<div id="intuit" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img8" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/innovative.jpg' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.intuit"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.intuitloginid"/> :</b>
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.intuitloginpassword"/> :</b>
								</td>
								<td style="font-size: 14px;">
				...
				<div id="iTransact" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img8" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/itransact.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.itransact"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.merchantid"/> :</b>
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.domainname"/> :</b>
								</td>
								<td style="font-size: 14px;">
				...
				<div id="linkPoint" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img8" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/linkpoint.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.linkpoint"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<bean:message key="BzComposer.configuration.userid"/> :
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								...
								<td style="font-size: 14px;">
									<html:file property="gatewayName" value="D:\Pritesh\bzc_12_04_2018(MySQL)\settings\linkpoint\CID_1"></html:file>
								</td>
							</tr>
						</table>
					</div>
				...
				<div id="payFlow" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img8" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/payflow.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.payflow"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.user"/> :</b>
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.vendor"/> :</b>
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.partner"/> :</b>
								</td>
								<td style="font-size: 14px;">
									<select id="payFlowPartner" name="payFlowPartner" onclick="showPayFlowPartner()" style="display:block;">
										<logic:present name="configurationForm" property="listOfExistingPaymentGateways"> 
											<logic:iterate name="configurationForm" id="objList1" property="listOfExistingPaymentGateways" scope="session">
												<option value="<bean:write name="objList1" property="gateWayId"/>" hidden disabled><bean:write name="objList1" property="fieldName3" /></option>
											</logic:iterate>
										</logic:present>
									</select>
				...
				<div id="paymentsGateway" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img8" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/PaymentsGateway.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center" style="font-size: 14px;">
									 <h1><b><bean:message key="BzComposer.configuration.paymentsgateway"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
				...
				<div id="psiGate" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img8" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/payment_gateway_logo_47.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.psigate"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
				...
				<div id="rtWare" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img8" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/rtware.jpg' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.rtware"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.rtwaremerchantid"/> :</b>
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.rtwaremerchantpassword"/> :</b>
								</td>
								<td style="font-size: 14px;">
				...
				<div id="skipJack" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img8" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/SkipJack.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.skipjack"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.skipjackserialnumber"/> :</b>
								</td>
								<td style="font-size: 14px;">
							...
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.skipjackdeveloperserialnumber"/> :</b>
								</td>
								<td style="font-size: 14px;">
				...
				<div id="USAePay" style="display:none;">
					<div>		
						<table style="width:750px;height:300px;">
							<tr>
								<td align="center">
									<img id="img7" src='<bean:write name="path" scope="session" property="pathvalue"/>/Payment Gateways/USAePay_New.gif' 
									style="display:block;width:150px;height:50px;" />
								</td>
								<td align="center">
									 <h1><b><bean:message key="BzComposer.configuration.usaepay"/></b></h1> 
								</td>
							</tr>
							<tr>
								<td align="center" style="font-size: 14px;">
									<b><bean:message key="BzComposer.configuration.usaepaytranscationkey"/> :</b>
								</td>
								<td style="font-size: 14px;">
				...
				<div align="center">
					<html:button property="save" style="font-size: 14px;"><bean:message key="BzComposer.global.save"/></html:button>
