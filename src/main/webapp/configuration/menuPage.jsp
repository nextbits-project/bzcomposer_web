...
<div id="table-negotiations" style="width: 180px;padding: 0; overflow-x:auto;max-height: 850px; position: relative;">
	<table class="tabla-listados" cellspacing="0" style="border: 0; margin: 0;">
		<thead style="position: top;">
			<tr>
				<td style="padding-left: 15px;">
					<%-- <html:button property="" styleClass="closebtn" onclick="closeNav()" style="width: 130px;"> &times; </html:button> --%>
					<%-- <html:button property="" styleId="togglebtn" onclick="toggleFunction()" style="width: 130px;"> + </html:button> --%>
				</td>
			</tr>
		</thead>
		<tbody id="divtoggle">
		<tr onclick="SetRow('tr1');" id="tr1">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config&&tab=tr2">
					<img id="img1" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/GeneralNew.png' style="display:block" /> 
				</a>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config&&tab=tr2">
					...
					<img id="img2" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/GeneralNewActive.png' style="display:none" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr2');" id="tr2">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config&&tab=tr2">
					<img id="img3" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/GeneralNew.png' style="display:block" />
				</a>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config&&tab=tr2"> 
					...
					<img id="img4" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/GeneralNewActive.png' style="display:none" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr6');" id="tr6">
			<td>
				...
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config6&&tab=tr6">
					...
					<img id="img12" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/CustomerInvoiceActive.png' style="display:none" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr8');" id="tr8">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config8&&tab=tr8">
					...
					<img id="img15" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/InventorySetting.png' style="display:block" />
				</a>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config8&&tab=tr8">
					...
					<img id="img16" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/InventorySettingActive.png' style="display:none" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr3');" id="tr3">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config03&&tab=tr3">
					...
					<img id="img5" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/AccountPayment.png' style="display:block" />
				</a>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config03&&tab=tr3">
					...
					<img id="img6" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/AccountPaymentActive.png' style="display:block" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr10');" id="tr10">
			<td>
				...
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config10&&tab=tr10">
					 <img id="img20" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/VendorPurchaseOrderActive.png' style="display:none" />
				 </a>
			 </td>
		</tr>
		<tr onclick="SetRow1('tr15');" id="tr15">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config15&&tab=tr15">
					...
					<img id="img29" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/ShippingNew.png' style="display:block" />
				</a>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config15&&tab=tr15">
					...
					<img id="img30" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/ShippingNewActive.png' style="display:none" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr9');" id="tr9">
			<td>
				...
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config9&&tab=tr9"> 
					...
					<img id="img18" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/FormCustomizationActive.png' style="display:none" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr11');" id="tr11">
			<td>
				...
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config11&&tab=tr11">
					...
					<img id="img22" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/EmployeeActive.png' style="display:none" />
				 </a>
			 </td>
		</tr>
		<tr onclick="SetRow1('tr12');" id="tr12">
			<td>
				...
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config12&&tab=tr12"> 
					...
					<img id="img24" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/TaxActive.png' style="display:none" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr4');" id="tr4">
			<td>
				...
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config04&&tab=tr4">
					...
					<img id="img8" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/NetworkSecurityActive.png' style="display:none" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr20');" id="tr20">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config20&&tab=tr20">
					...
					<img id="img39" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/DeviceManager.png' style="display:block" />
				</a>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config20&&tab=tr20">
					...
					<img id="img40" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/DeviceManagerActive.png' style="display:none" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr21');" id="tr21">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config21&&tab=tr21">
					...
					<img id="img41" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/PaymentGateways.png' style="display:block" />
				</a>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config21&&tab=tr21">
					...
					<img id="img42" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/PaymentGatewaysActive.png' style="display:none" />
				</a>
			</td>
		</tr>
		<tr onclick="SetRow1('tr22');" id="tr22">
			<td>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config22&&tab=tr22">
					 <img id="img43" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/printer-new.png' style="display:block" />
					<%-- <img id="img43" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/printer.png' style="display:block" /> --%>
				</a>
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config22&&tab=tr22"> 
					 <img id="img44" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/printer-new-active.png' style="display:none" />
					<%-- <img id="img44" src='<bean:write name="path" scope="session" property="pathvalue"/>/ConfigurationImages/printerActive.png' style="display:none" /> --%>
				</a>
			</td>
		</tr>
		</tbody>
		<%-- commented on 30-04-2020 for menu change 
		...
		<tr onclick="SetRow1('tr23');" id="tr23">
			<td>
				...
				<a href="<bean:write name="path" property="pathvalue"/>/Configuration.do?tabid=config23&&tab=tr13">
...
<script type="text/javascript">
	...
	function setTableVisible1(t1)
	{
		...
		else if(t1=="tr22")
		{
			...
			document.getElementById('img43').style.display='none';
			document.getElementById('img44').style.display='block';
			/*xdocument.getElementById('img45').style.display='block';
			document.getElementById('img46').style.display='none';
			document.getElementById('img47').style.display='block';
			document.getElementById('img48').style.display='none';
			document.getElementById('img49').style.display='block';
