...
<title><bean:message key="BzComposer.itemtitle" /></title>
<style type="text/css">
.height250 {
	height: 47%;
	overflow-x: auto;
						...
						<div id="padding">
							<div>
								<span
									...
									<bean:message key="BzComposer.item.iteminfo" />
								</span>
							</div>
							<div>
							...
							<table style="margin-left: 50%;">
								<tr align="center">
									<td style="font-size: 1em;"><input type="button"
										class="formbutton" name="AddItemBtn"
										value="<bean:message key='BzComposer.global.add'/>"
										onclick="ShowAdd();" title="Add New Item"></td>
									<td style="font-size: 1em;"><input type="button"
										class="formbutton" name="AddItemBtn"
										value="<bean:message key='BzComposer.global.edit'/>"
										onclick="callEdit();" title="Edit Item"></td>
									<td style="font-size: 1em;"><input type="button"
										class="formbutton" name="AddItemBtn"
										value="<bean:message key='BzComposer.global.delete'/>"
										onclick="callDelete();" title="Delete Item"></td>
									<td style="font-size: 1em;"><input type="button"
										class="formbutton" name="AddItemBtn"
										value="<bean:message key='BzComposer.item.refreshbtn'/>"
										onclick="callRefresh();" title="Refresh Item"></td>
								</tr>
							</table>
