...
<!-- 			key="BzComposer.Email" /></a></li> -->
	...
	<ul>
		...
		<li id="current" style="margin-left: 1px"><a
			href="<bean:write name="path" property="pathvalue"/>/Sales.do?tabid=SalesBoard"
	   ...
	   <li><a href="Estimation.do?tabid=EstimationBoard" title=""><span><bean:message
		...
		<li><a href="<bean:write name="path" property="pathvalue"/>/RMA.do?tabid=R0M0A0" title="RMA" ><span><bean:message
