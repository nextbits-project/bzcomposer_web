			...
			<table class="tabla-listados" cellspacing="0" align="left">
				...
				<tr>
					<td colspan="4" align="center">
						...
						<html:submit styleId="add" property="Save" title="Save Address" styleClass="formbutton" onclick="submitFormAdd(this.form);">
							Add
						</html:submit>
						<!-- <button type="button" id="update" class="formbutton" value="Update" onclick="submitFormUpdate(this.form);">Update</button> -->
						<html:submit styleId="update" property="update" title="Save Address" styleClass="formbutton" onclick="submitFormUpdate(this.form);">
							Update
						</html:submit>
						&nbsp;&nbsp;
