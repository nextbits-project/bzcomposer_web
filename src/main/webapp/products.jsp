...
<title><bean:message key="BzComposer.productstitle"/></title>
<style>
.highlight
{
...
<body>
	...
	<div id="divProducts" class="container">
		<div id="products" class="para-temp">
			<h2>
				<bean:message key="BzComposer.products.title"/>
			</h2>
			<bean:message key="BzComposer.products.titlecontent"/>
		</div>
	 	<div id="bzcomposerRetailFreeWare" class="para-temp">
			<h4 style="float: left; width: 100%;">
				<b>
					<bean:message key="BzComposer.product.retailfreeware"/>
				</b>
			</h4>
			<bean:message key="BzComposer.products.retailfreewarecontent"/>
	  	</div> 
	  	<div id="bzcomposerStandard" class="para-temp">
	   		<h4 style="float: left; width: 100%;">
	   			<b>
	   				<bean:message key="BzComposer.product.standard"/>
   				</b>
			</h4>
			<bean:message key="BzComposer.products.standardcontent"/>
		</div>
		...
		<div id="bzcomposerBilling" class="para-temp">
	   		<h4 style="float: left; width: 100%;">
	   			<b>
	   				<bean:message key="BzComposer.product.billing"/>
   				</b>
			</h4>
	  		...
	  		<bean:message key="BzComposer.products.billingcontent"/>
	  	</div>
	  	<div id="bzcomposereSales" class="para-temp">
	   		<h4 style="float: left; width: 100%;">
	   			<b>
	   				<bean:message key="BzComposer.product.esales"/>
   				</b>
			</h4>
	  		...
	  		<bean:message key="BzComposer.products.esalescontent"/>
	  	</div>
	  	<div id="bzcomposerProfessional" class="para-temp">
	   		<h4 style="float: left; width: 100%;">
	   			<b>
	   				<bean:message key="BzComposer.products.professional"/>
   				</b>
			</h4>
	  		<bean:message key="BzComposer.products.professionalcontent"/>
	  	</div>
	  	...
	  	<div id="webDesignForUs" class="para-temp">
	  		<h4 style="float: left; width: 100%;">
	  			<b>
	  				<bean:message key="BzComposer.products.webdesignforus"/>
  				</b>
			</h4>
	  		<bean:message key="BzComposer.products.webdesignforuscontent"/>
	  	</div>	
	</div>
