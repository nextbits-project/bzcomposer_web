...
<title><bean:message key="BzComposer.addnewcompanystep6title" /></title>
</head>
<body>
	<html:form action="CompanyNew.do?tabid=createNewCompany7" method="post" styleId="myform">
	...
	<div class="bca_createnewcompanyright_title">
		<h3><bean:message key="BzComposer.addnewcompanystep6title" /></h3>
	</div>
			...
			<div class="createNewCoupaLeft">
				<div class="fieldset">
					...
					<div class="fieldset">
						...
						<div class="radio">
							<label> <input type="radio" name="optionsRadios"
								id="optionsRadios1" value="option1"> Name
							</label>
						</div>
						<div class="radio">
							<label> <input type="radio" name="optionsRadios"
					...
					<div class="bca_companylist">
						...
						<html:select property="a" multiple="multiple" styleId="customerlist" onclick="getCompanyname()">
				...
				<!-- <div class="tabContant"> -->
					...
					<div id="tabs-2" class="pl-2 pr-2 pt-3 pb-1">
							...
							<div class="fieldset">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										...
										<html:select property="iSalesTerm" styleId="term">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										...
										<html:select property="iSalesRep" styleId="salesrep">
								...
								<div class="form-group row">
									<label for="inputEmail3" class="col-sm-2 control-label">Received
										Method:</label>
									<div class="col-sm-10">
										...
										<html:select property="iSalesPayMethod" styleId="receivedmethod">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										...
										<html:select property="iSalesShipMethod" styleId="shipcarrier">
							...
							<div class="fieldset">
								...
								<div class="form-group row">
									<label for="inputEmail3" class="col-sm-2 control-label">Card
										Type:</label>
									<div class="col-sm-10">
										<%-- <select id="cardtype">
										...
										<html:select property="iSalesCardType" styleId="cardtype">
								...
								<div class="form-group row">
									<label for="inputEmail3" class="col-sm-2 control-label">Card
										Holder Name:</label>
									<div class="col-sm-10">
										<html:text property="sSalesCardName" styleId="cardholdername"></html:text>
									</div>
								</div>
								...
								<div class="form-group row">
									<label for="inputEmail3" class="col-sm-2 control-label">Card
										Number:</label>
									<div class="col-sm-10">
										<html:text property="sSalesCardNumber" styleId="cardnumber"></html:text>
									</div>
								</div>


								<div class="form-group row">
									<label for="inputEmail3" class="col-sm-2 control-label">Exp.
										Date:</label>
									<div class="col-sm-10">
										...
										<div class="form-inline">
											...
											<div class="form-group">
												<html:text property="iSalesCardExpMonth"></html:text>
												<input type="text" name="iSalesCardExpMonth" placeholder="Please enter a month">
												<input type="text" name="iSalesCardExpYear" placeholder="Please enter a year">	
											</div>
										</div>
									</div>
								</div>
	...
	<!-- ---------------------------------------------------------------------------------------------------------------------------------------------------- -->
					<div class="fieldset">
						...
						<div class="form-group row">
							<label for="inputEmail3" class="col-sm-2 control-label">Unpaid Balance:</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="unpaidbalance" name="dSalesUnpaidBalance"
									placeholder="0.0">
							</div>
						</div>
						<div class="form-group row">
							<label for="inputEmail3" class="col-sm-2 control-label">Existing Credit:</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="existingcredit" name="dSalesExistingCredit"
								placeholder="0.0">
							</div>
						</div>
						<div class="form-group row">
				...
				<div id="tabs-1" class="pl-2 pr-2 pt-3 pb-1">
					<div class="fieldset">
						...
						<div class="form-group">
							<label for="">Company Name:</label> <input type="text" id="companyname" name="sGeneralCompanyName"
								class="form-control" required="required">
						</div>
						<div class="form-group">
							<label for="">First Name:</label> <input type="text" name="sGeneralFirstName"
								class="form-control" id="fnm" required="required">
						</div>
						<div class="form-group">
							<label for="">Last Name:</label> <input type="text" name="sGeneralLastName"
								class="form-control" id="lnm" required="required">
						</div>
						<div class="form-group">
							<label for="">Address1*:</label> <input type="text" name="sGeneralAddress1"
								class="form-control" id="address1" required="required">
						</div>
						<div class="form-group">
							<label for="">Address2:</label> <input type="text" name="sGeneralAddress2"
								class="form-control" id="address2">
						</div>
						<div class="form-group">
							<label for="">City*:</label> <input type="text" name="sGeneralCity"
						...
						<div class="form-group">
							...
							<html:select property="iGeneralState" styleId="state">
						...
						<div class="form-group">
							<label for="">Province:</label> <input type="text" name="sGeneralProvince"
								class="form-control" id="province">
						</div>
						<div class="form-group">
							<label for="">Zip Code*:</label> <input type="text" name="sGeneralZip"
								class="form-control" id="zipcode" required="required" onkeypress="return isNumber(event)">
						</div>
						<div class="form-group">
							...
							<html:select property="iGeneralCountry" styleId="country">
						...
						<div class="form-group">
							<label for="">Phone:</label> <input type="text" name="sGeneralPhone"
								class="form-control" id="phone">
						</div>
						<div class="form-group">
							<label for="">Fax:</label> <input type="text" name="sGeneralFax"
								class="form-control" id="fax">
						</div>
						<div class="form-group">
							<label for="">Homepage:</label> <input type="text" name="sGeneralHomepage"
						...
						<div class="form-group">
							...
							<html:select property="iGeneralCategory" styleId="category">
								<logic:present name="CompanyInfoForm" property="cCategory_Name"> 
									<logic:iterate name="CompanyInfoForm" id="objList1" property="cCategory_Name" scope="session">
										<option value="<bean:write name='objList1' property='commonid' />"><bean:write name="objList1" property="name"/></option>
									</logic:iterate>
								</logic:present> 
							</html:select>
						</div>
						<div class="form-group">
							<label for="">Email ID*:</label> <input type="text" name="sGeneralEmail"
							class="form-control" id="email" required="required">
						</div>
						<div class="form-inline">
							<div class="form-group">
								<label for="">Tax ID*:</label> <input type="text" name="sGeneralTaxID"
									class="form-control" id="taxid" style="width: 600px;">
							</div>
							<div class="checkbox-inline">
								<!-- <label> <input type="radio" name="optionsRadios2"
									id="taxable" value="Taxable">Taxable
								</label> -->
								<label> <input type="checkbox" id="taxable">Taxable
								</label>
							</div>
							<div class="checkbox-inline">
								<!-- <label> <input type="radio" name="optionsRadios2"
									id="isAlsoVendor" value="Is Also Vendor">Is Also Vendor
								</label> -->
				...
				<div id="tabs-3" class="pl-2 pr-2 pt-3 pb-1">
					<div class="fieldset">
						...
						<div class="form-group">
						 ...
						 <div>   
							<label for="">Company</label> <input type="text" name="sBillingAddressCompany"
								class="form-control" id="billing_companyname">
						</div>
						<div class="form-group">
							<label for="">First Name:</label> <input type="text" name="sBillingAddressFirstName"
								class="form-control" id="billing_fnm">
						</div>
						<div class="form-group">
							<label for="">Last Name:</label> <input type="text" name="sBillingAddressLastName"
								class="form-control" id="billing_lnm">
						</div>
						<div class="form-group">
							<label for="">Address1*:</label> <input type="text" name="sBillingAddressAddress1"
							class="form-control" id="billing_add1">
						</div>
						<div class="form-group">
							<label for="">Address2:</label> <input type="text" name="sBillingAddressAddress2"
							class="form-control" id="billing_add2">
						</div>
						<div class="form-group">
							<label for="">City*:</label> <input type="text" name="sBillingAddressCity"
						...
						<div class="form-group">
							...
							<html:select property="iBillingAddressState" styleId="billing_state">
								<logic:present name="CompanyInfoForm" property="listOfStates"> 
									<logic:iterate name="CompanyInfoForm" id="objList1" property="listOfStates" scope="session">
										<option value="<bean:write name='objList1' property='stateCode' />"><bean:write name="objList1" property="stateCode"/></option>
									</logic:iterate>
						...
						<div class="form-group">
							<label for="">Province:</label> <input type="text" name="sBillingAddressProvince"
							class="form-control" id="billing_province">
						</div>
						<div class="form-group">
							<label for="">Zip Code*:</label> <input type="text" name="sBillingAddressZip"
							class="form-control" id="billing_zipcode" onkeypress="return isNumber(event)">
						</div>
						<div class="form-group">
							<label for="">Country*:</label> 
							...
							<html:select property="iBillingAddressCountry" styleId="billing_country">
								<logic:present name="CompanyInfoForm" property="listOfCountries"> 
									<logic:iterate name="CompanyInfoForm" id="objList1" property="listOfCountries" scope="session">
										<option value="<bean:write name='objList1' property='countryId' />"><bean:write name="objList1" property="country"/></option>
									</logic:iterate>
				...
				<div id="tabs-4" class="pl-2 pr-2 pt-3 pb-1">
					<div class="fieldset">
						...
						<div class="form-group">
						 ...
						 <div>   
							<label for="">Company</label> <input type="text" name="sShippingAddressCompany"
								class="form-control" id="shipping_companyname">
						</div>
						<div class="form-group">
							<label for="">First Name:</label> <input type="text" name="sShippingAddressFirstName"
								class="form-control" id="shipping_fnm">
						</div>
						<div class="form-group">
							<label for="">Last Name:</label> <input type="text" name="sShippingAddressLastName"
								class="form-control" id="shipping_lnm">
						</div>
						<div class="form-group">
							<label for="">Address1*:</label> <input type="text" name="sShippingAddressAddress1"
								class="form-control" id="shipping_address1">
						</div>
						<div class="form-group">
							<label for="">Address2:</label> <input type="text" name="sShippingAddressAddress2"
								class="form-control" id="shipping_address2">
						</div>
						<div class="form-group">
							<label for="">City*:</label> <input type="text" name="sShippingAddressCity"
						...
						<div class="form-group">
							...
							<html:select property="iShippingAddressState" styleId="shipping_state">
							<logic:present name="CompanyInfoForm" property="listOfStates"> 
								<logic:iterate name="CompanyInfoForm" id="objList1" property="listOfStates" scope="session">
									<option value="<bean:write name='objList1' property='stateCode' />"><bean:write name="objList1" property="stateCode"/></option>
								</logic:iterate>
						...
						<div class="form-group">
							<label for="">Province:</label> <input type="text" name="sShippingAddressProvince"
								class="form-control" id="shipping_province">
						</div>
						<div class="form-group">
							<label for="">Zip Code*:</label> <input type="text" name="sShippingAddressZip"
								class="form-control" id="shipping_zipcode" onkeypress="return isNumber(event)">
						</div>
						<div class="form-group">
							<label for="">Country*:</label> 
							...
							<html:select property="iShippingAddressCountry" styleId="shipping_country">
							<logic:present name="CompanyInfoForm" property="listOfCountries"> 
								<logic:iterate name="CompanyInfoForm" id="objList1" property="listOfCountries" scope="session">
									<option value="<bean:write name='objList1' property='countryId' />"><bean:write name="objList1" property="country"/></option>
								</logic:iterate>
...
<!-- -----------------------------------------------------------Common----------------------------------------------------------------------------------------- -->
		<div class="createNewCoupaRight">
			<div class="fieldset">
				...
				<div class="radio">
					<label> <input type="radio" name="customerGroupID"
						id="customerGroupID" value="0" checked> Dealers
					</label>
				</div>
				<div class="radio">
					<label> <input type="radio" name="customerGroupID"
						id="customerGroupID" value="1"> Local Customer
					</label>
				</div>
				<div class="radio">
					<label> <input type="radio" name="customerGroupID"
						id="customerGroupID" value="option3"> eSales Customer
					</label>
				</div>
			<%-- 	<logic:iterate name="CompanyInfoForm" id="objList1" property="vListCustomerGroup" scope="session">
					<div class="radio">
						<label>
						   <html:radio property="customerGroupID" value="<bean:write name='objList1' property='customerGroupID' />"><bean:write name="objList1" property="country"/></html:radio>
						</label>
					</div>
				</logic:iterate> --%>
			</div>
...
function submitform()
{
	...
	{	
	 document.forms[0].action = "CompanyNew.do?tabid=createNewCompany7";
	 document.forms[0].submit();
		...
		var json = JSON.stringify(objGlobalForGeneral);
		 $.ajax({
			...
			type : "POST",
			url : "CompanyNew.do?tabid=addCustomer",
			data : "json=" +json ,
