...
<html:html lang="en">
<title>BzComposer-Partners</title>
...
{    
	...
	var txt1 = $('#divPartners').html();
	if(term.length>1)
	{
		if(term == 'Style' || term == 'style' || term == 'Class' || term == 'class ' || term == 'para-temp')
		{

			document.getElementById("divPartners").innerHTML = txt1;
		}
		else
		{
			var txt = $('#divPartners').html().replace(highlightRe,'$1');
			
			if(term !== '') {
			        txt = txt.replace(new RegExp('(' + term + ')', 'gi'), highlightHtml);
			}    
			$("#divPartners").html(txt);
			setTimeout(function(){ 
				document.getElementById("divPartners").innerHTML = txt1;
			}, 5000);
		}	
...
function searchTextMobile()
{
	...
	<h2>Partners</h2>
	<div class="para-temp">
	   <h4 style="float: left; width: 100%;"><b>Our Partners:</b></h4>
	   <ol>
			 <!--<li>Nexbits:<a href="https://www.nextbits.com">Nexbits</a></li>
			  <li>Nextbizz:<a href="https://www.nextbizz.com">Nextbizz</a></li>
			  <li>HealthcareMaxx:<a href="https://www.healthcaremaxx.com">HealthcareMaxx</a></li>
			  <li>Nextcome:<a href="https://www.nextcome.com">Nextcome</a></li>
			  <li>TheSmartster:<a href="https://www.thesmartster.com">TheSmartster</a> </li>
			  <li>Best10Reviews:<a href="https://www.best10reviews.com">Best10Reviews</a></li> -->
			  <li><a href="https://www.nextbits.com">Nexbits</a></li>
			  <li><a href="https://www.nextbizz.com">Nextbizz</a></li>
			  <li><a href="https://www.healthcaremaxx.com">HealthcareMaxx</a></li>
			  <li><a href="https://www.nextcome.com">Nextcome</a></li>
			  <li><a href="https://www.thesmartster.com">TheSmartster</a> </li>
			  <li><a href="https://www.best10reviews.com">Best10Reviews</a></li>
		</ol>   
	</div>
	<div>
	</div>
