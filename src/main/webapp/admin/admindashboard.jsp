...
<title><bean:message key="BzComposer.admin.title.comapanyliststitle" /></title>
<style type="text/css">
.height250 {
	height: 47%;
	overflow-x: auto;
						...
						<div id="padding">
							<div>
								<span
									...
									<bean:message key="BzComposer.admin.title.comapanylists" />
								</span>
							</div>
							<div>
									...
									<table id="myTable01" class="tabla-listados" cellpadding="0"
										...
										<thead style="font-weight: bold;">
											<tr>
												...
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.ComanyAddrees" /></th>
												...
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.Membership" /></th>
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.PaymentPlan" /></th>
										...
										<tbody>
											<logic:present name="cList">
												<logic:notEmpty name="cList">
													<bean:size name="cList" id="cListSize" />
													<input type="hidden" name="listSize" id="lSize"
														value='<bean:write name="cListSize" />'>
													<logic:iterate name="cList" id="objList1"
														indexId="ndx">
														<tr id='<bean:write name="ndx" />$$'
															onclick="callClick('<bean:write name="ndx" />$$','<bean:write name="objList1" property="companyid" />');"
															>
															<td colspan="1" style="font-size: 1em;"><bean:write
																	name="objList1" property="companyid" /></td>
															<td colspan="1" style="font-size: 1em;"><bean:write
																	name="objList1" property="companyName" /></td>
															<td colspan="2" style="font-size: 1em;"><bean:write
																	name="objList1" property="companyaddress" /></td>
															<td style="font-size: 1em;">&nbsp;<bean:write
																	name="objList1" property="membershipLevel" />
															</td>
															<td style="font-size: 1em;">&nbsp;<bean:write
																	name="objList1" property="paymentPlan" />$
															</td>
