...
<title><bean:message key="BzComposer.admin.title.ApplicationUsertitle" /></title>
<style type="text/css">
.height250 {
	height: 47%;
	overflow-x: auto;
						...
						<div id="padding">
							<div>
								<span
									...
									<bean:message key="BzComposer.admin.title.ApplicationUser" />
								</span>
							</div>
							<div>
										...
										<thead style="font-weight: bold;">
											<tr>
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.UserName" /></th>
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.Group" /></th>
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.Status" /></th>
												<th class="emblem" style="font-size: 1em;"><bean:message
											...
											<logic:present name="Userlist">
												<logic:notEmpty name="Userlist">
													...
													<input type="hidden" name="listSize" id="lSize"
														value='<bean:write name="UserlistSize" />'>
													<logic:iterate name="Userlist" id="objList1"
														indexId="ndx">
														<tr id='<bean:write name="ndx" />$$'
															onclick="callClick('<bean:write name="ndx" />$$','<bean:write name="objList1" property="groupName" />');"
															>
															<td colspan="1" style="font-size: 1em;"><bean:write
																	name="objList1" property="userName" /></td>
															<td colspan="1" style="font-size: 1em;"><bean:write
																	name="objList1" property="groupName" /></td>
															<td colspan="1" style="font-size: 1em;"><bean:write
																	name="objList1" property="status" /></td>
															<td colspan="1" style="font-size: 1em;"><bean:write
