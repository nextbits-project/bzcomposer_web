...
<html>
<head>
	<title><bean:message key="BzComposer.adminlogintitle"/></title>
	<meta charset="utf-8">
...
<html:form action="Login.do?tabid=chkLoginDetails" method="post" onsubmit="formValue1();">
		...
		<div class="card bg-white" style="max-width:500px; margin: 0px auto; margin-top:110px; border-radius: 65px;">
 			<div class="card-body">
				<h2 class="card-title" align="center">
					<bean:message key="BzComposer.admin.title"/>
					<!-- Sign In -->
				</h2>
				<br>
					...
					<br>
		   			<div class="form-group" align="center">
						<!-- <label for="userName" class="">Email address</label> -->				
 						...
 						styleClass="\" autoComplete=\"off" value=""/>
			 		</div>
		   			<div class="form-group" align="center">
 						<!-- <label for="password" class="">Password:</label> -->		
						<html:password property="password" styleId="password" style="width:250px;" value="" />
					</div>
			   		<div class="form-group" align="center">
						<html:checkbox property="rememberMe" styleId="rememberMe" value="">
							&nbsp;
