...
<title><bean:message key="BzComposer.admin.title.ComapanyContactstitle" /></title>
<style type="text/css">
.height250 {
	height: 47%;
	overflow-x: auto;
						...
						<div id="padding">
							<div>
								<span
									...
									<bean:message key="BzComposer.admin.title.ComapanyContacts" />
								</span>
							</div>
							<div>
										...
										<thead style="font-weight: bold;">
											<tr>
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.ID" /></th>
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.CompanyName" /></th>
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.ContactName" /></th>
												
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.Phone" /></th>
												<th class="emblem" style="font-size: 1em;"><bean:message
														key="BzComposer.admin.table.column.Email" /></th>
										...
										<tbody>
											<logic:present name="CustomerList">
												<logic:notEmpty name="CustomerList">
													<bean:size name="CustomerList" id="CustomerListSize" />
													<input type="hidden" name="listSize" id="lSize"
														value='<bean:write name="CustomerListSize" />'>
													<logic:iterate name="CustomerList" id="objList1"
														indexId="ndx">
														<tr id='<bean:write name="ndx" />$$'
															onclick="callClick('<bean:write name="ndx" />$$','<bean:write name="objList1" property="clientVendorID" />');"
															>
															<td colspan="1" style="font-size: 1em;"><bean:write
																	name="objList1" property="clientVendorID" /></td>
															<td colspan="1" style="font-size: 1em;"><bean:write
																	name="objList1" property="companyName" /></td>
															<td colspan="1" style="font-size: 1em;"><bean:write
																	name="objList1" property="firstName" /></td>
															<td colspan="1" style="font-size: 1em;"><bean:write
																	name="objList1" property="phone" /></td>
															<td colspan="1" style="font-size: 1em;"><bean:write
																	name="objList1" property="email" /></td>
														</tr>
													</logic:iterate>
												</logic:notEmpty>
											</logic:present>
