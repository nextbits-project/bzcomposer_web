...
function refreshItemsNow(val)
{
  curr=null;
  o = c(writeSelect);
  oGET(o,'<bean:write name="path" property="pathvalue" />/include/GetEmployeeList1.jsp?type=' + val)
}
function sendTo()
{
	debugger;
...
<div>
	<span style="font-size:1.6em;font-weight:normal;color:#838383;margin:30px 0px 15px 0px;border-bottom:1px dotted #333;padding:0 0 .3em 0;">
		<bean:message key="BzComposer.employeeprintlabels.printlabeltitle" />
	</span>
</div>
							...
							<tbody>
								<tr>
									<td align="left" style="font-size: 1em;">
										...
										<input type="hidden" name="listSize" id="lSize" value='<bean:write name="lSize" />'>
							...
							<thead>
								<tr>
									<th style="text-align:center;font-size: 1em;">
										<bean:message key="BzComposer.employeeprintlabels.selectaddresslabeltype" />
									</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td style="font-size:1em;">
										<select id="labelType" name="labelType">
											<option value="0">
												<bean:message key="BzComposer.employeeprintlabels.selectlabel" />
											</option>
								...
								<tr>
									<td align="center" style="font-size:1em;">
										<input type="button" class="formbutton" value="<bean:message key="BzComposer.employeeprintlabels.setuplabel" />">
									</td>
								</tr>
								<tr>
									<td style="font-size:1em;">
										<bean:message key="BzComposer.employeeprintlabels.employeelisttoprint" />
									</td>
								</tr>
								<tr>						
									<td style="font-size:1em;">
			...
			<tbody>
				<tr>
					<td colspan="4" align="center">
						<input type="button" value="<bean:message key="BzComposer.employeeprintlabels.sendto" />"
				class="formbutton" onclick="sendTo();">
				&nbsp;&nbsp;&nbsp;
				<input type="hidden" name="SelectedRID" id="setRID" value=""> 
				<input type="button" value="<bean:message key="BzComposer.employeeprintlabels.printlabelbtn"   />" 
				class="formbutton" onclick="printlabel();" >
				&nbsp;&nbsp;&nbsp;
				<input type="button" value="<bean:message key="BzComposer.employeeprintlabels.cleardata" />"
...
<div id="showCustomerValidationDialog" style="display:none;">
	<p><bean:message key="BzComposer.employeeprintlabels.selectemployee"/></p>
</div>
<div id="showlabelValidationDialog" style="display:none;">
	<p><bean:message key="BzComposer.employeeprintlabels.selectlabeltoupdate"/></p>
</div>