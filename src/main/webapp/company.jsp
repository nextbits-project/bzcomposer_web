...
<html:html>
<title><bean:message key="BzComposer.companypagetitle"/></title>
...
function openSampleCompany4()
{
		...
		<div class="header header-mobile-1">
			...
			<div class="au-navbar-mobile navbar-mobile-1">
				<ul class="au-navbar-menu">
					...
					<li><a href="#"><bean:message key="BzComposer.aboutus"/></a></li>
	...
	<div id="companyInfo" class="container">
		<h2><bean:message key="BzComposer.company.company"/></h2>
	    <p class="para-temp "><b><bean:message key="BzComposer.company.companytextone"/></b></p>
	    
	    <p class="para-temp"><b><bean:message key="BzComposer.company.nextbits"/></b> 
	    <bean:message key="BzComposer.company.companytexttwo"/>
	    </p>
	    
	    <p class="para-temp">
	    	<bean:message key="BzComposer.company.companytextthree"/>
	    </p>
	    
	    <p class="para-temp">
	    	<bean:message key="BzComposer.company.companytextfour"/>
	    </p>
	    <p class="para-temp">
	    	<bean:message key="BzComposer.company.companytextfive"/>
	    </p>
	</div>
