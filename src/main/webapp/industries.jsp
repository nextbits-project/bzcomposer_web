...
<%-- <html:html lang="en"> --%>
<html:html>
<title><bean:message key="BzComposer.industriestitle"/></title>
<style>
.highlight
{
...
<div id="divIndustires" class="container">
	<h2>
		<bean:message key="BzComposer.industries.industries"/>
	</h2>
	
	<div class="para-temp">
		<bean:message key="BzComposer.industries.industriescontent"/>
	</div>
	<div class="para-temp">
		<h4 style="float: left; width: 100%;">
			<b>
				<bean:message key="BzComposer.industries.retailers"/>
			</b>
		</h4>
	    <p class="para-temp">
	    	<bean:message key="BzComposer.industries.retailerscontentone"/>
	    </p>
	    <p class="para-temp">
	    	<bean:message key="BzComposer.industries.retailerscontenttwo"/>
	    </p> 
	</div>
	<div class="para-temp">
		<h4 style="float: left; width: 100%;">
			<b>
				<bean:message key="BzComposer.industries.manuacturerandwholesaler"/>			
			</b>
		</h4>
	    <bean:message key="BzComposer.industries.manuacturerandwholesalercontent"/>	    
	</div>
	<div class="para-temp">
		<h4 style="float: left; width: 100%;">
			<b>
				<bean:message key="BzComposer.industries.professionalservicecompany"/>
			</b>
		</h4>
	    <bean:message key="BzComposer.industries.professionalservicecompanycontent"/>
	</div>
	<div class="para-temp">
		<h4 style="float: left; width: 100%;">
	   		<b>
	   			<bean:message key="BzComposer.industries.ecommercecompany"/>
   			</b>
		</h4>
	    <bean:message key="BzComposer.industries.ecommercecompanycontent"/>
	</div>
</div>
