...
public class AddNewCompanyAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, CompanyInfoDto companyInfoForm, HttpServletRequest request,
...
//			AddNewCompanyDAO dao = new AddNewCompanyDAO();
		...
		if (action.equalsIgnoreCase("createNewCompany2")) {
			...
			if (isDuplicateName == true) {
				...
				forward = "Failure";
			} else if (companyInfoForm.getCompanyName() == null
