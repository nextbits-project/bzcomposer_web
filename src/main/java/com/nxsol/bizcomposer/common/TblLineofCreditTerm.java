...
//	@GeneratedValue(strategy = GenerationType.IDENTITY)
	...
	public boolean isDueAfter(java.util.Date from) {
		...
		return getDueDate().after(from) || ConstValue.getSimpleDateFormat().format(from)
				.equals(ConstValue.getSimpleDateFormat().format(getDueDate()));
	...
	public boolean isDueBefore(java.util.Date to) {
		...
		return getDueDate().before(to) || ConstValue.getSimpleDateFormat().format(to)
				.equals(ConstValue.getSimpleDateFormat().format(getDueDate()));
	}
	...
	public boolean equals(Object obj) {
		...
		if (this == obj)
			return true;
		if (!(obj instanceof TblLineofCreditTerm))
			return false;

		TblLineofCreditTerm other = (TblLineofCreditTerm) obj;
		if (this.getCreditTermId() != other.getCreditTermId())
			return false;
