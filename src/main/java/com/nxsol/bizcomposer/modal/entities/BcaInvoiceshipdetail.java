...
public class BcaInvoiceshipdetail {
    ...
    private BcaRealtimeshippingservice shippingService;
    ...
    public BcaRealtimeshippingservice getShippingService() {
        return shippingService;
    }

    public void setShippingService(final BcaRealtimeshippingservice shippingService) {
