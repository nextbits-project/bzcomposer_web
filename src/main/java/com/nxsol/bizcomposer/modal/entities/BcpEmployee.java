...
public class BcpEmployee {
    ...
    private Set<BcaInvoicememorized> employeeBcaInvoicememorizeds;

    @OneToMany(mappedBy = "employee")
    private Set<BcaInvoiceshipped> employeeBcaInvoiceshippeds;
    ...
    public Set<BcaInvoicememorized> getEmployeeBcaInvoicememorizeds() {
        return employeeBcaInvoicememorizeds;
    }

    public void setEmployeeBcaInvoicememorizeds(
            final Set<BcaInvoicememorized> employeeBcaInvoicememorizeds) {
        this.employeeBcaInvoicememorizeds = employeeBcaInvoicememorizeds;
    }

    public Set<BcaInvoiceshipped> getEmployeeBcaInvoiceshippeds() {
        return employeeBcaInvoiceshippeds;
    }

    public void setEmployeeBcaInvoiceshippeds(
            final Set<BcaInvoiceshipped> employeeBcaInvoiceshippeds) {
        this.employeeBcaInvoiceshippeds = employeeBcaInvoiceshippeds;
    }
