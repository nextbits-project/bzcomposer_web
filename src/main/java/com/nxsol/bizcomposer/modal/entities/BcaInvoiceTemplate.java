...
public class BcaInvoiceTemplate {
    ...
    @OneToMany(mappedBy = "template")
    private Set<BcaInvoiceLayoutfieldssetting> templateBcaInvoiceLayoutfieldssettings;
    ...
    public Set<BcaInvoiceLayoutfieldssetting> getTemplateBcaInvoiceLayoutfieldssettings() {
        return templateBcaInvoiceLayoutfieldssettings;
    }

    public void setTemplateBcaInvoiceLayoutfieldssettings(
            final Set<BcaInvoiceLayoutfieldssetting> templateBcaInvoiceLayoutfieldssettings) {
        this.templateBcaInvoiceLayoutfieldssettings = templateBcaInvoiceLayoutfieldssettings;
    }
