 ...
 */
/**
 * SQLResults stores the results of a sql query in the form of objects stored in
 * an Arraylist container object. It contains handy methods like getLong(),
 * getDate(), getString(), etc. for accessing fields in a SQLResults (result
 * set). <br>
 * <br>
 * 
 ...
 * </pre>
 * 
 * There is also a handy toString() method which can be used to generate a text
 * table of the entire contents of the SQLResults result set. Here is a code
 * example:
 * 
 * <pre>
