    ...
    public List<Item> getItemListByCategory(String categoryId, String compId) {
        ...
        try {
            String sqlString = "SELECT InventoryID,ParentID,InventoryCode,InventoryName,InventoryDescription,Qty,Weight,SalePrice,isCategory,ItemTypeID,SerialNum "
                    + "FROM bca_iteminventory WHERE ParentID=" + categoryId + " and CompanyID=" + compId + " and Active=1";
...
//				============================== Services ==============================
    ...
    public InvoiceDto getRecordForSalesOrder(String compId, String orderNo, InvoiceDto form, HttpServletRequest
            request) {
        PreparedStatement pstmt = null;
        SQLExecutor db = new SQLExecutor();
        Connection con = db.getConnection();
...
//				form.setIsPending(rs.getInt("InvoiceTypeID") == 7 ? "true": "false");
    ...
    public InvoiceDto getRecordForInvoice(String compId, String orderNo, InvoiceDto form, HttpServletRequest
            request) {
        PreparedStatement pstmt = null;
        SQLExecutor db = new SQLExecutor();
        Connection con = db.getConnection();
    ...
    public ArrayList searchHistory(HttpServletRequest request, String cond, String cvId, String periodFrom, String
            periodTo) {
