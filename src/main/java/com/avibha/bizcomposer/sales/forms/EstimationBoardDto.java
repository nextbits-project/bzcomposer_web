...
public class EstimationBoardDto {
    ...
    private String datesCombo;		//Added on 23-07-2019

    private String fromDate;		//Added on 23-07-2019
    private String toDate;			//Added on 23-07-2019
    ...
    public String getOrderNoFrom() { return orderNoFrom; }
    public void setOrderNoFrom(String orderNoFrom) { this.orderNoFrom = orderNoFrom; }

    public String getOrderNoTo() { return orderNoTo; }
    public void setOrderNoTo(String orderNoTo) { this.orderNoTo = orderNoTo; }
