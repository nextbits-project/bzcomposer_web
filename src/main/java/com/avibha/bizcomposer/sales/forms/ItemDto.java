...
public class ItemDto implements Serializable {
	...
	/*public ArrayList<ItemDto> getListOfExistingLocation() {
		return listOfExistingLocation;
	}

	public void setListOfExistingLocation(ArrayList<ItemDto> listOfExistingLocation) {
	...
	public String getDealerPrice() { return dealerPrice; }

	public void setDealerPrice(String dealerPrice) { this.dealerPrice = dealerPrice; }
	...
	public void setActualWeight(String actualWeight) { this.actualWeight = actualWeight; }
