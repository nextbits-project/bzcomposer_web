...
public class MultiUserFormValidator {
	...
	public boolean isMultiUserValidValue(MultiUserForm mform, MessageSource messageSource, HttpServletRequest request) {
		logger.info("muform :" + mform + " Request :" + request);
		Locale locale = LocaleContextHolder.getLocale();
		if (mform.getMembershipLevel() == null || mform.getMembershipLevel().equals("")
				|| mform.getMembershipLevel().equals("select membership")) {
			logger.info("inside emty membership level");
			request.setAttribute("errorMsg",
					messageSource.getMessage("BzComposer.register.selectmembership", new Object[] {}, locale));
			return true;
		} else if (mform.getEmailAddress() == null || mform.getEmailAddress().equals("")) {
			logger.info("inside emty email address");
			request.setAttribute("errorMsg",
					messageSource.getMessage("AddEmployeeForm.email.problem", new Object[] {}, locale));
			return true;
			...
			request.setAttribute("errorMsg",
					messageSource.getMessage("AddEmployeeForm.fname.problem", new Object[] {}, locale));
			return true;
		} else if (mform.getLastName().equals("") || mform.getLastName() == null) {
			logger.info("inside emty last name");
			request.setAttribute("errorMsg",
					messageSource.getMessage("AddEmployeeForm.lname.problem", new Object[] {}, locale));
			return true;
		} else if (mform.getJobPosition().equals("select jobPosition") || mform.getJobPosition().equals("")
				|| mform.getJobPosition() == null) {
			logger.info("inside BzComposer.register.selectjobposition");
			request.setAttribute("errorMsg",
					messageSource.getMessage("BzComposer.register.selectjobposition", new Object[] {}, locale));
			return true;
		} else if (mform.getCompanyName() == null || mform.getCompanyName().equals("")) {
			logger.info("inside emty comapny name");
			request.setAttribute("errorMsg",
					messageSource.getMessage("BzComposer.NewCustomer.Name.Validation", new Object[] {}, locale));
			return true;
		} else if (mform.getAddress1() == null || mform.getAddress1().equals("")) {
			logger.info("inside empty getAddress1");
			request.setAttribute("errorMsg",
					messageSource.getMessage("AddEmployeeForm.address1.problem", new Object[] {}, locale));
			return true;
			...
			request.setAttribute("errorMsg",
					messageSource.getMessage("err.registration.invalidstate", new Object[] {}, locale));
			return true;
		} else if (mform.getCity().equals("Select City") || mform.getCity() == null || mform.getCity().equals("")) {
			logger.info("inside emty city");
			request.setAttribute("errorMsg",
					messageSource.getMessage("AddEmployeeForm.city.problem", new Object[] {}, locale));
			return true;
			...
			request.setAttribute("errorMsg",
					messageSource.getMessage("AddEmployeeForm.phone.problem", new Object[] {}, locale));
			return true;
		 ...
		 * request.setAttribute("errorMsg",
		 * messageSource.getMessage("err.user.username.required", new
		 * Object[]{},locale)); return true; } else
		 * if(mform.getPasswordhint().equals("select a question")
		 * ||mform.getPasswordhint()==null||mform.getPasswordhint().equals("")) {
		 * logger.info("inside select a question"); request.setAttribute("errorMsg",
		 * messageSource.getMessage("BzComposer.register.selectquestion", new
		 * Object[]{},locale)); return true; } else
		 * if(mform.getPasswordAns().equals("")|| mform.getPasswordAns()==null){
		 * logger.info("inside select a question");
		 * request.setAttribute("errorMsg",messageSource.getMessage(
		 * "BzComposer.register.selectquestion", new Object[]{},locale)); return true; }
		 */
...
//			request.setAttribute("errorMsg",
//					messageSource.getMessage("AddEmployeeForm.expDate.problem", new Object[] {}, locale));
//			return true;
//		}
		return false;
	}
...
//		Pattern pattern = Pattern.compile("-?\\d+(\\.\\d+)?");
		Pattern pattern = Pattern.compile("\\d{10,12}|\\d*\\(\\d{3}\\)\\s\\d{3}\\-\\d{4}");
		if (strNum == null) {
			return false;
		}
