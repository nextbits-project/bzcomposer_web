...
public class MultiUserForm {
    ...
    private String membershipLevel;			//Added on 17-09-2019
    ...
    public boolean isSameAsPhoneNumber() {
        return sameAsPhoneNumber;
    }

    public void setSameAsPhoneNumber(boolean sameAsPhoneNumber) {
    ...
    public void setDateExpiry(String dateExpiry) { this.dateExpiry = dateExpiry; }
