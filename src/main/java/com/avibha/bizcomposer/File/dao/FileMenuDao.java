            ...
            if(name[1].equals("csv"))
            {
                ...
                while ((line=Bufferederreader.readLine())!=null) {
                    ...
                    try {
                        ...
                        System.err.println("exception bcoz not upload proper csv file in customer upload internalpanelcustomer.java"+ex);
                ...
                if(name[1].equals("xlsx"))
                {
                    ...
                    while(iterator.hasNext())
                    {
                        ...
                        while(cellIterator.hasNext())
                        {
                            ...
                            if(!((Data.equalsIgnoreCase("Company Name")) || (Data.equalsIgnoreCase("Mr/Ms")) || (Data.equalsIgnoreCase("Company")) || (Data.equalsIgnoreCase("FirstName")) || (Data.equalsIgnoreCase("LastName")) || (Data.equalsIgnoreCase("Address1")) || (Data.equalsIgnoreCase("Address2")) || (Data.equalsIgnoreCase("City")) || (Data.equalsIgnoreCase("State")) || (Data.equalsIgnoreCase("ZipCode")) || (Data.equalsIgnoreCase("Country")) || (Data.equalsIgnoreCase("Phone")) || (Data.equalsIgnoreCase("CellPhone")) || (Data.equalsIgnoreCase("Fax")) || (Data.equalsIgnoreCase("Email")) || (Data.equalsIgnoreCase("DateAdded")) || (Data.equalsIgnoreCase("Active")) || (Data.equalsIgnoreCase("COMPANY NAME"))))
                            {
                ...
                if(a == 1) {
                    ...
                    if(type.equals("customer")) {
                        ...
                        String sql1 = " INSERT INTO bca_clientvendor ( ClientVendorID, CompanyID, "
                                ...
                                + "Address2,City,State, ZipCode, Country , Phone, CellPhone, "
                                + "Fax, Email, DateAdded, Active, Status, CVTypeID,Deleted)"
                                + " VALUES ( "+cvId + "," + ConstValue.companyId +","+ al.get(0)+","+ al.get(1)+","+ al.get(2)+","+ al.get(3)+","+ al.get(4)+","+ al.get(5)+","+ al.get(6)+","+ al.get(7)+","+ al.get(8)+","+al.get(9)+","+al.get(10)+","+al.get(11)+","+al.get(12)+","
                                + ""+al.get(13)+","+al.get(14)+",";
                    }
                    con = db.getConnection();
                    stmt = con.createStatement();
