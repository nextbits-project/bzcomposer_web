...
public class AuthorizeNetUtils {
    ...
    private String apiLoginId = "82nf2AJdAN";
    private String transactionKey = "685W42LZM6FgKjac"; //5DeBxwEL62e6339e

    private void setMerchantAuthentication(){
    ...
    public ANetApiResponse checkoutPayment(Double amount) {
