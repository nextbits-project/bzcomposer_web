...
public class PurchaseBoard implements Cloneable {
	...
	public String getPoNumStr() { return poNumStr; }
	public void setPoNumStr(String poNumStr) { this.poNumStr = poNumStr; }
