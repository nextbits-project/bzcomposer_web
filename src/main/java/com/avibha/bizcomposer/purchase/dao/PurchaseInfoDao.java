...
public class PurchaseInfoDao {
	...
	public boolean insertVendor(VendorDto c, String compID) {
		...
		try {
			 ...
			 */
			pstmt.setDate(32, (c.getDateInput()==null || c.getDateInput().trim().equals(""))?null:cinfo.string2date(c.getDateInput()));
			pstmt.setDate(33, (c.getTerminatedDate()==null || c.getTerminatedDate().trim().equals(""))?null:cinfo.string2date(c.getTerminatedDate()));
